            ...
            if ($result == TRUE) {
                ...
                if ($admin_details != false) {
                    ...
                    $session_data = array(
                        ...
                        'school' => $admin_details[0]->school,
                        'email' => $admin_details[0]->email,
                        'session_id'=>$admin_details[0]->session_id,
...
function userlogin() {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            if ($result) {
                if ($result[0]->is_active == "yes") {
                    ...
                    else if ($result[0]->role == "teacher_head") {
                        $result = $this->user_model->read_sub_admin_information($username);
                    }
                    ...
                    if ($result != false) {
                        ...
                        if ($result[0]->role == "student") {
                            ...
                            $session_data = array(
                                ...
                                'school' => $result[0]->school,
                                'inter_class' => $result[0]->inter_class,
                                ...
                                'is_rtl' => $setting_result[0]['is_rtl'],
                                'theme' => $setting_result[0]['theme'],
                                'redirectto'=>"parent/parents/dashboard"
                            );
                            $this->session->set_userdata('student', $session_data);
    ...
    { 
        ...
        $this->load->view('stuattendence_form', $data);
    ...
    { 
        ...
        //$this->load->view('layout/header', $data);
        $this->load->view('teaattendence_form', $data);
       // $this->load->view('layout/footer', $data);
    }
     ...
     function insert_teaattendance()
    {
        ...
        $outtime=date("Y-m-d H:i:s");
            ...
            $data=array(
             ...
             $this->db->where("teacher_id",$tea_id);
             $this->db->where("created_at",date("Y-m-d"));
