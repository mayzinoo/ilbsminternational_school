...
class studentfee extends CI_Controller {
    ...
    function printvoc($id) {
        ...
        $this->load->view('accountant/studentfee/studentfeePrint', $data);
    ...
    function create($id) {
        ...
        if ($this->form_validation->run() == FALSE) {
           ...
           redirect(base_url()."accountant/studentfee/printvoc/".$header_id."/".$id);
    ...
    function delete($id) {
        ...
        redirect('accountant/studentfee/index/1');
    }
    ...
    function edit($id) {
        ...
        if ($this->form_validation->run() == FALSE) {
            $this->load->view('layout/accountant/header', $data);
            $this->load->view('accountant/studentfee/studentfeeEdit', $data);
            $this->load->view('layout/accountant/footer', $data);
        } else {
             $paydate= date("Y-m-d",strtotime($this->input->post('date'))).date(", h:i:s");
            $data = array(
    ...
    function studentfeesreport()
    {
        ...
        $data['classlist'] = $class;
        $this->load->view('layout/accountant/header', $data);
        $this->load->view('accountant/studentfee/studentfeesreport', $data);
        $this->load->view('layout/accountant/footer', $data);
    ...
    function studentfeesMonthlyReport()
    {
        ...
        $data['classlist'] = $class;
        $this->load->view('layout/accountant/header', $data);
        $this->load->view('accountant/studentfee/studentfeesMonthlyReport', $data);
        $this->load->view('layout/accountant/footer', $data);
    ...
    function studentfeesMonthlyreportPrint()
    {
        ...
        $class = $this->class_model->get();
        $data['classlist'] = $class;
        $this->load->view('accountant/studentfee/studentfeesMonthlyreportPrint', $data);
 ...
 function studentfeesMonthlyreportSearch()
    {
        ...
        $data['title'] = 'student fees';
        $resultlist = $this->Studentfee_model->studentfeesMonthlyreportSearch($status,$month,$class,$section);
        $data['resultlist'] =$resultlist;
        $class = $this->class_model->get();
        $data['classlist'] = $class;
        $this->load->view('layout/accountant/header', $data);
        $this->load->view('accountant/studentfee/studentfeesMonthlyReportSearch', $data);
        $this->load->view('layout/accountant/footer', $data);
    ...
    function studentfeesYearlyReport()
    {
        ...
        $data['classlist'] = $class;
        $this->load->view('layout/accountant/header', $data);
        $this->load->view('accountant/studentfee/studentfeesYearlyReport', $data);
        $this->load->view('layout/accountant/footer', $data);
    ...
    function studentfeesYearlyreportPrint()
    {
        ...
        $class = $this->class_model->get();
        $data['classlist'] = $class;
        $this->load->view('accountant/studentfee/studentfeesYearlyreportPrint', $data);
 ...
 function studentfeesYearlyreportSearch()
    {
        ...
        $status=1;     
        $data['title'] = 'student fees';
        $resultlist = $this->Studentfee_model->studentfeesYearlyreportSearch($status,$year,$class,$section);
        $data['resultlist'] =$resultlist;
        $class = $this->class_model->get();
        $data['classlist'] = $class;
        $this->load->view('layout/accountant/header', $data);
        $this->load->view('accountant/studentfee/studentfeesYearlyReportSearch', $data);
        $this->load->view('layout/accountant/footer', $data);
    ...
    function studentfeesDailyReport()
    {
        ...
        $data['classlist'] = $class;
        $this->load->view('layout/accountant/header', $data);
        $this->load->view('accountant/studentfee/studentfeesDailyReport', $data);
        $this->load->view('layout/accountant/footer', $data);
    ...
    function studentfeesDailyreportPrint()
    {
        ...
        $class = $this->class_model->get();
        $data['classlist'] = $class;
        $this->load->view('accountant/studentfee/studentfeesDailyreportPrint', $data);
 ...
 function studentfeesDailyreportSearch()
    {
        ...
        $status=1;     
        $data['title'] = 'student fees';
        $resultlist = $this->Studentfee_model->studentfeesDailyreportSearch($status,$day,$class,$section);
        $data['resultlist'] =$resultlist;
        $class = $this->class_model->get();
        $data['classlist'] = $class;
        $this->load->view('layout/accountant/header', $data);
        $this->load->view('accountant/studentfee/studentfeesDailyReportSearch', $data);
        $this->load->view('layout/accountant/footer', $data);
