...
class Preschool_Reportcard extends Admin_Controller {
    ...
    function activity() {
     ...
     function rpcardsfront() {
       ...
       $data["reportcard_subject"]=$this->db->order_by("id","ASC")->get("reportcard_subject");
        ...
        ->get_where("improvement_result_details",array('student_id'=>$student_id,'improvement_id'=>'3'))->row();
        
        // echo $data["impro_result3"]->num_rows();exit;
        $data["impro_result4"]=$this->db->get_where("improvement_result_details",array('student_id'=>$student_id,'improvement_id'=>'4'))->row();
        $data["impro_result5"]=$this->db->get_where("improvement_result_details",array('student_id'=>$student_id,'improvement_id'=>'5'))->row();
        $data["impro_result6"]=$this->db->get_where("improvement_result_details",array('student_id'=>$student_id,'improvement_id'=>'6'))->row();
        
        $this->load->view('admin/preschoolreportcard/reportcardFrontPrint', $data);
    }
    function rpcardsback() {
       ...
       $data["school_activity"]=$this->db->order_by("id","ASC")->get("school_activity");
        ...
        $data["impro_result"]=$this->db->get_where("improvement_result_details",array('student_id'=>$student_id,'improvement_id'=>'7'))->row();
         $data["impro_result13"]=$this->db->get_where("improvement_result_details",array('student_id'=>$student_id,'improvement_id'=>'13'))->row();
        ...
        $this->load->view('admin/preschoolreportcard/reportcardBackPrint', $data);
    }
