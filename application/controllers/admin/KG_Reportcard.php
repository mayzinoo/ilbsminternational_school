...
class KG_Reportcard extends Admin_Controller {
    ...
    function searchkgimpro(){
        $improid=$this->input->post("improid");
		$this->db->where("header_id",$improid);
		$query = $this->db->get("kgimprovement_detail");
    ...
    //     $this->load->view('admin/reportcard/reportcardFrontPrint', $data);
    // }
    function rpcardsfront() {
        $student_id=$this->uri->segment(4);
        $setting_result = $this->Reportcard_model->reportcard_head();
       ...
       $data["kgimpro1"]=$this->db->get_where("kgimprovement_detail",array('header_id'=>'1'))->row();
       $data["kgimpro2"]=$this->db->get_where("kgimprovement_detail",array('header_id'=>'2'))->row();
       $data["kgimpro3"]=$this->db->get_where("kgimprovement_detail",array('header_id'=>'3'))->row();
       $data["kgimpro4"]=$this->db->get_where("kgimprovement_detail",array('header_id'=>'4'))->row();
       $data["kgimpro5"]=$this->db->get_where("kgimprovement_detail",array('header_id'=>'5'))->row();
       $data["kgimpro6"]=$this->db->get_where("kgimprovement_detail",array('header_id'=>'6'))->row();
       
       $data["kgimpro_result"]=$this->db->get_where("kgimprovement_result_details",array('student_id'=>$student_id,'improvement_id'=>'1'))->row();
       
       $data["kgimpro_result2"]=$this->db->get_where("kgimprovement_result_details",array('student_id'=>$student_id,'improvement_id'=>'2'))->row();
       
       $data["kgimpro_result3"]=$this->db->get_where("kgimprovement_result_details",array('student_id'=>$student_id,'improvement_id'=>'3'))->row();
       
       $data["kgimpro_result4"]=$this->db->get_where("kgimprovement_result_details",array('student_id'=>$student_id,'improvement_id'=>'4'))->row();
       
       $data["kgimpro_result5"]=$this->db->get_where("kgimprovement_result_details",array('student_id'=>$student_id,'improvement_id'=>'5'))->row();
       
       $data["kgimpro_result6"]=$this->db->get_where("kgimprovement_result_details",array('student_id'=>$student_id,'improvement_id'=>'6'))->row();
       

        $this->load->view('admin/kgreportcard/kgreportcardFrontPrint', $data);
    }
    
    
     /*mzo*/
     function prerpcardsfront() {
       ...
       $data["reportcard_subject"]=$this->db->order_by("id","ASC")->get("reportcard_subject");
        ...
        $data["impro_result3"]=$this->db
        ->get_where("improvement_result_details",array('student_id'=>$student_id,'improvement_id'=>'3'));
        
        
        
        $data["impro_result4"]=$this->db->get_where("improvement_result_details",array('student_id'=>$student_id,'improvement_id'=>'4'));
        $data["impro_result5"]=$this->db->get_where("improvement_result_details",array('student_id'=>$student_id,'improvement_id'=>'5'));
        $data["impro_result6"]=$this->db->get_where("improvement_result_details",array('student_id'=>$student_id,'improvement_id'=>'6'));
