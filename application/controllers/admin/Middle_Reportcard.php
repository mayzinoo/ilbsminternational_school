...
class Middle_Reportcard extends Admin_Controller {
    ...
    function rpcardsfront() {
	   ...
	   $data["reportcard_subject"]=$this->db->order_by("id","ASC")->get_where("reportcard_subject",array("level"=>"middle"));
        ...
        $this->load->view('admin/reportcard/middlereportcardFront', $data);
    }
    ...
    function printwithgrade() {
	   ...
	   $data["reportcard_subject"]=$this->db->order_by("id","ASC")->get_where("reportcard_subject",array("level"=>"middle"));
        ...
        $this->load->view('admin/reportcard/middlereportcardFrontwithGrades', $data);
    }
	...
	function rpcardsback() {
       ...
       $data["school_activity"]=$this->db->order_by("id","ASC")->get("school_activity");
        ...
        $this->load->view('admin/reportcard/middlereportcardBack', $data);
    }
