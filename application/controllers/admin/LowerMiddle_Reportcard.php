...
class LowerMiddle_Reportcard extends Admin_Controller {
    ...
    function rpcardsfront() {
	   ...
	   $data["reportcard_subject"]=$this->db->order_by("id","ASC")->get_where("reportcard_subject",array("level"=>"lowermiddle"));
        ...
        $this->load->view('admin/reportcard/lowermiddlereportcardFront', $data);
    }
    ...
    function printwithgrade() {
	   ...
	   $data["reportcard_subject"]=$this->db->order_by("id","ASC")->get_where("reportcard_subject",array("level"=>"lowermiddle"));
        ...
        $this->load->view('admin/reportcard/lowermiddlereportcardFrontwithGrades', $data);
    }
	...
	function rpcardsback() {
       ...
       $data["school_activity"]=$this->db->order_by("id","ASC")->get("school_activity");
        ...
        $this->load->view('admin/reportcard/lowermiddlereportcardBack', $data);
    }
