...
class Inter_exam extends Admin_Controller {
    ...
    public function examclasses($id) {
        ...
        $this->session->set_userdata('sub_menu', 'inter_exam/index');
        ...
        $this->load->view('admin/inter_exam/examClasses', $data);
    ...
    function index() {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            redirect('admin/inter_exam/index');
        }
        $exam_result = $this->exam_model->get();
        $data['examlist'] = $exam_result;
        $this->load->view('layout/header', $data);
        $this->load->view('admin/inter_exam/examList', $data);
    ...
    function view($id) {
        ...
        $data['exam'] = $exam;
        $this->load->view('layout/header', $data);
        $this->load->view('inter_exam/examShow', $data);
        $this->load->view('layout/footer', $data);
    }
    ...
    function create() {
        ...
        if ($this->form_validation->run() == FALSE) {
            $this->load->view('layout/header', $data);
            $this->load->view('inter_exam/examCreate', $data);
            $this->load->view('layout/footer', $data);
        } else {
            $data = array(
    ...
    function edit($id) {
        ...
        if ($this->form_validation->run() == FALSE) {
            $this->load->view('layout/header', $data);
            $this->load->view('admin/inter_exam/examEdit', $data);
            $this->load->view('layout/footer', $data);
        } else {
            $data = array(
                'id' => $id,
    ...
    function examSearch() {
        ...
        if ($this->input->server('REQUEST_METHOD') == "POST") {
            ...
            $this->load->view('layout/header', $data);
            $this->load->view('admin/inter_exam/examSearch', $data);
            $this->load->view('layout/footer', $data);
        } else {
            $this->load->view('layout/header', $data);
            $this->load->view('admin/inter_exam/examSearch', $data);
