...
class Infocenter extends Admin_Controller {
    ...
    function __construct() {
        ...
        $this->load->model("Infocenter_model");
    }
    ...
    function index() {
        ...
        $this->session->set_userdata('sub_menu', 'Infocenter/index');
    ...
    
    {
        ...
        $resultlist = $this->Infocenter_model->get_feedbacks($status);
        $data['resultlist'] =$resultlist;
        $this->load->view('layout/header', $data);
        $this->load->view('infocenter/feedbacks', $data);
        $this->load->view('layout/footer', $data);
