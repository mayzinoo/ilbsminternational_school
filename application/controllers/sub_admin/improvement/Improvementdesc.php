...
class Improvementdesc extends CI_Controller {
    ...
    function index() {
        ...
        $this->load->view('teacher/improvement/improvementdescList', $data);
    ...
    function createform()
    {
        ...
        $this->load->view('layout/teacher/header', $data);
        $this->load->view('teacher/improvement/improvementdescCreate');// $data);
        $this->load->view('layout/teacher/footer', $data);
    }
    ...
    function view($id) {
        ...
        $data['lists'] = $lists;
        $this->load->view('layout/teacher/header', $data);
        $this->load->view('teacher/improvement/improvementdescShow', $data);
        $this->load->view('layout/teacher/footer', $data);
    }
