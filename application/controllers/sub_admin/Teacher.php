...
class Teacher extends CI_Controller {
    ...
    function index() {
        ...
        $this->load->view('layout/sub_admin/header', $data);
        $this->load->view('sub_admin/teacher/teacherList', $data);
        $this->load->view('layout/sub_admin/footer', $data);
    }
    ...
    function dashboard() {
        ...
        $this->load->view('layout/sub_admin/header', $data);
        $this->load->view('sub_admin/dashboard', $data);
        $this->load->view('layout/sub_admin/footer', $data);
    }
    ...
    function assign_Teacher() {
        ...
        $this->load->view('layout/sub_admin/header', $data);
        $this->load->view('sub_admin/teacher/assignTeacher', $data);
        $this->load->view('layout/sub_admin/footer', $data);
        if ($this->input->server('REQUEST_METHOD') == "POST") {
            ...
            foreach ($loop as $key => $value) {
                ...
                $s['teacher_id'] = $this->input->post('sub_admin_id_' . $value);
            ...
            redirect('sub_admin/teacher/assignTeacher');
        }
    }
    ...
    function views($id) {
        ...
        $data['teachersubject'] = $teachersubject;
        $this->load->view('layout/sub_admin/header', $data);
        $this->load->view('sub_admin/teacher/teacherShow', $data);
        $this->load->view('layout/sub_admin/footer', $data);
    }
    ...
    function deletes($id) {
        ...
        redirect('sub_admin/teacher/index');
    }
    ...
    function creates() {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $data['genderList'] = $genderList;
            $this->load->view('layout/sub_admin/header', $data);
            $this->load->view('sub_admin/teacher/teacherCreate', $data);
            $this->load->view('layout/sub_admin/footer', $data);
        } else {
            $data = array(
    ...
    function edit($id) {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $data['teacherlist'] = $teacher_result;
            $this->load->view('layout/sub_admin/header', $data);
            $this->load->view('sub_admin/teacher/teacherEdit', $data);
            $this->load->view('layout/sub_admin/footer', $data);
        } else {
            $data = array(
                'id' => $id,
    ...
    function getlogindetail() {
        $teacher_id = $this->input->post('sub_admin_id');
    ...
    function changeusername() {
            ...
            if ($is_valid) {
                ...
                if (!$is_exists) {
                    ...
                    if ($is_updated) {
                        ...
                        redirect('sub_admin/teacher/changeusername');
                    }
                } else {
        ...
        $this->data['username'] = $sessionData['username'];
        $this->load->view('layout/sub_admin/header', $data);
        $this->load->view('sub_admin/change_username', $data);
        $this->load->view('layout/sub_admin/footer', $data);
    }
