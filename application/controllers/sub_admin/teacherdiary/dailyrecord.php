...
class Dailyrecord extends CI_Controller {
    ...
    function index() {
        ...
        $data["lists"]=$this->Dailyrecord_model->getByeachTeacher($stu["student"]["teacher_id"]);


        $this->load->view('layout/teacher/header', $data);
        $this->load->view('teacher/teacherdiary/dailyrecordList');// $data);
    ...
    function createform()
    {
        ...
        $data['sectionlists'] = $this->Common_model->grab_section();
        $this->load->view('layout/teacher/header', $data);
        $this->load->view('teacher/teacherdiary/dailyrecordCreate');// $data);
        $this->load->view('layout/teacher/footer', $data);
    }
    ...
    function view($id) {
        ...
        $data['lists'] = $lists;
        $this->load->view('layout/teacher/header', $data);
        $this->load->view('teacher/teacherdiary/DailyrecordShow', $data);
        $this->load->view('layout/teacher/footer', $data);
    }
    ...
    function delete($id) {
        ...
        $this->Dailyrecord_model->remove($id);
            redirect('teacher/teacherdiary/Dailyrecord/index');
    }
    ...
    function edit($id) {
        ...
        if ($this->form_validation->run() == FALSE) {
            $this->load->view('layout/teacher/header', $data);
            $this->load->view('teacher/teacherdiary/DailyrecordEdit', $data);
            $this->load->view('layout/teacher/footer', $data);
        } else {
             $data = array(
                'id' => $id,                
