...
// echo $month;exit;
            ...
            $data["resultlist"]=$res;
            $this->load->view('layout/teacher/header', $data);
            $this->load->view('teacher/stuattendence/monthly_attendenceList', $data);
            $this->load->view('layout/teacher/footer', $data);
        } else {
        $this->form_validation->set_rules('class_id', 'Class', 'trim|required|xss_clean');
        $this->form_validation->set_rules('section_id', 'Section', 'trim|required|xss_clean');
...
// echo $month;exit;
            ...
            $this->load->view('layout/teacher/header', $data);
            $this->load->view('teacher/stuattendence/monthly_attendence_percentList', $data);
            $this->load->view('layout/teacher/footer', $data);
        } else {
        $this->form_validation->set_rules('class_id', 'Class', 'trim|required|xss_clean');
        $this->form_validation->set_rules('section_id', 'Section', 'trim|required|xss_clean');
    ...
    function leave()
    {
        ...
        if ($this->input->server('REQUEST_METHOD') == "GET") {
            ...
            $data["resultlist"]=$res;
            $this->load->view('layout/teacher/header', $data);
            $this->load->view('teacher/stuattendence/leavelist', $data);
            $this->load->view('layout/teacher/footer', $data);
        } else {
        $this->form_validation->set_rules('class_id', 'Class', 'trim|required|xss_clean');
        $this->form_validation->set_rules('section_id', 'Section', 'trim|required|xss_clean');
...
function stumaintenance_insert()
    {
        ...
        $authority = $this->session->userdata['student']['teacher_id'];
      ...
      for($i=0;$i<count($stu_id);$i++) 
	   ...
	   $this->session->set_flashdata('msg', '<div class="alert alert-success text-left">'.$err.'</div>');

		redirect("teacher/Stuattendence/classattendencereport");
