...
class Reportcard extends CI_Controller {
    ...
    function activity() {
     ...
     $data["reportcard_month"]=$this->Common_model->grab_month();
        ...
        $this->load->view('teacher/reportcard/activityList', $data);
     ...
     function index() {
        ...
        $data['studentlist'] = $student_result;
        $this->load->view('layout/teacher/header', $data);
        $this->load->view('teacher/reportcard/reportcardList', $data);
        $this->load->view('layout/teacher/footer', $data);
            ...
            if (isset($search)) {
                if ($search == 'search_filter') {
                    ...
                    if ($this->form_validation->run() == FALSE) {
                        ...
                        $this->load->view('teacher/reportcard/activityformList', $data);
    ...
    function rpcardsfront() {
	   ...
	   $data["reportcard_subject"]=$this->db->order_by("id","ASC")->get("reportcard_subject");
        ...
        $this->load->view('teacher/reportcard/reportcardFrontPrint', $data);
    }
    ...
    function printwithgrade() {
	   ...
	   $data["reportcard_subject"]=$this->db->order_by("id","ASC")->get("reportcard_subject");
        ...
        $this->load->view('teacher/reportcard/reportcardFrontPrintwithGrades', $data);
    }
	...
	function rpcardsback() {
       ...
       $data["school_activity"]=$this->db->order_by("id","ASC")->get("school_activity");
        ...
        $this->load->view('teacher/reportcard/reportcardBackPrint', $data);
    }
    ...
    function rpcardsbackwithgrades() {
       ...
       $data["school_activity"]=$this->db->order_by("id","ASC")->get("school_activity");
        ...
        $this->load->view('teacher/reportcard/reportcardBackPrintwithGrades', $data);
    }
