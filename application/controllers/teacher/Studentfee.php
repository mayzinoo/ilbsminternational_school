...
class studentfee extends CI_Controller {
    ...
    function index() {
        ...
        $this->session->set_userdata('sub_menu', 'teacher/studentfee/index');
        $data['title'] = 'student fees';
        $data["school"]=$this->Common_model->grab_school();

        $resultlist = $this->Studentfee_model->get($status);
    ...
    function feesearch() {
        $this->session->set_userdata('top_menu', 'Fees Collection');
        $this->session->set_userdata('sub_menu', 'teacher/studentfee/feesearch');
        $data['title'] = 'student fees';
        $class = $this->class_model->get();
        $data['classlist'] = $class;
    ...
    function reportbyname() {
        $this->session->set_userdata('top_menu', 'Fees Collection');
        $this->session->set_userdata('sub_menu', 'teacher/studentfee/reportbyname');
        $data['title'] = 'student fees';
        $data['title'] = 'student fees';
        $class = $this->class_model->get();
        $data['classlist'] = $class;
    ...
    function printvoc($id) {
        ...
        $this->load->view('teacher/studentfee/studentfeePrint', $data);
    ...
    function create($id) {
        ...
        $this->form_validation->set_rules('payment_for', 'payment_for', 'trim|required|xss_clean');
        ...
        if ($this->form_validation->run() == FALSE) {
           ...
           redirect(base_url()."teacher/studentfee/printvoc/".$header_id."/".$id);
  ...
  function delete($id) {
        ...
        redirect('teacher/studentfee/index/1');
    }
    ...
    function searchpayment() {
        $this->session->set_userdata('top_menu', 'Fees Collection');
        $this->session->set_userdata('sub_menu', 'teacher/studentfee/searchpayment');
        $data['title'] = 'Edit studentfees';
    ...
    {
        $this->session->set_userdata('top_menu', 'Fees Collection');
        $this->session->set_userdata('sub_menu', 'teacher/studentfee/studentfeesMonthlyReport');
        ...
        $data['classlist'] = $class;
        $this->load->view('layout/teacher/header', $data);
        $this->load->view('teacher/studentfee/studentfeesMonthlyReport', $data);
        $this->load->view('layout/teacher/footer', $data);
    ...
    function studentfeesMonthlyreportPrint()
    {
        ...
        $class = $this->class_model->get();
        $data['classlist'] = $class;
        $this->load->view('teacher/studentfee/studentfeesMonthlyreportPrint', $data);
 ...
 function studentfeesMonthlyreportSearch()
    {
        ...
        $data['title'] = 'student fees';
        $resultlist = $this->Studentfee_model->studentfeesMonthlyreportSearch($status,$month,$class,$section,$search_text);
        $data['resultlist'] =$resultlist;
        $class = $this->class_model->get();
        $data['classlist'] = $class;
        $this->load->view('layout/teacher/header', $data);
        $this->load->view('teacher/studentfee/studentfeesMonthlyReportSearch', $data);
        $this->load->view('layout/teacher/footer', $data);
    ...
    {
        $this->session->set_userdata('top_menu', 'Fees Collection');
        $this->session->set_userdata('sub_menu', 'teacher/studentfee/studentfeesYearlyReport');
		$year=date("Y");
        ...
        $data['classlist'] = $class;
        $this->load->view('layout/teacher/header', $data);
        $this->load->view('teacher/studentfee/studentfeesYearlyReport', $data);
        $this->load->view('layout/teacher/footer', $data);
    ...
    function studentfeesYearlyreportPrint()
    {
        ...
        $class = $this->class_model->get();
        $data['classlist'] = $class;
        $this->load->view('teacher/studentfee/studentfeesYearlyreportPrint', $data);
 ...
 function studentfeesYearlyreportSearch()
    {
        ...
        $status=1;     
        $data['title'] = 'student fees';
        $resultlist = $this->Studentfee_model->studentfeesYearlyreportSearch($status,$year,$class,$section,$search_text);
        $data['resultlist'] =$resultlist;
        $class = $this->class_model->get();
        $data['classlist'] = $class;
        $this->load->view('layout/teacher/header', $data);
        $this->load->view('teacher/studentfee/studentfeesYearlyReportSearch', $data);
        $this->load->view('layout/teacher/footer', $data);
    ...
    {
        $this->session->set_userdata('top_menu', 'Fees Collection');
        $this->session->set_userdata('sub_menu', 'teacher/studentfee/studentfeesDailyReport');
        $day=date("Y-m-d");
        ...
        $data['classlist'] = $class;
        $this->load->view('layout/teacher/header', $data);
        $this->load->view('teacher/studentfee/studentfeesDailyReport', $data);
        $this->load->view('layout/teacher/footer', $data);
    ...
    function studentfeesDailyreportPrint()
    {
        ...
        $class = $this->class_model->get();
        $data['classlist'] = $class;
        $this->load->view('teacher/studentfee/studentfeesDailyreportPrint', $data);
 ...
 function studentfeesDailyreportSearch()
    {
        ...
        $status=1;     
        $data['title'] = 'student fees';
        $resultlist = $this->Studentfee_model->studentfeesDailyreportSearch($status,$day,$class,$section,$search_text);
        $data['resultlist'] =$resultlist;
        $class = $this->class_model->get();
        $data['classlist'] = $class;
        $this->load->view('layout/teacher/header', $data);
        $this->load->view('teacher/studentfee/studentfeesDailyReportSearch', $data);
        $this->load->view('layout/teacher/footer', $data);
    ...
    {
        $this->session->set_userdata('top_menu', 'Fees Collection');
        $this->session->set_userdata('sub_menu', 'teacher/studentfee/studentfeesdaylyReport');
        $day=$this->session->userdata("sel_day");
        $class=$this->session->userdata("class_id");
        $search_text=$this->session->userdata("search_text");
