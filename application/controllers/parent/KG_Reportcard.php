...
class KG_Reportcard extends CI_Controller {
    ...
    function rpcardsfront() {
       ...
       $data["kgimpro_result"]=$this->db->get_where("kgimprovement_result_details",array('student_id'=>$student_id,'header_id'=>'1'))->row();
       
       $data["kgimpro_result2"]=$this->db->get_where("kgimprovement_result_details",array('student_id'=>$student_id,'header_id'=>'2'))->row();
       
       $data["kgimpro_result3"]=$this->db->get_where("kgimprovement_result_details",array('student_id'=>$student_id,'header_id'=>'3'))->row();
       
       $data["kgimpro_result4"]=$this->db->get_where("kgimprovement_result_details",array('student_id'=>$student_id,'header_id'=>'4'))->row();
       
       $data["kgimpro_result5"]=$this->db->get_where("kgimprovement_result_details",array('student_id'=>$student_id,'header_id'=>'5'))->row();
       
       $data["kgimpro_result6"]=$this->db->get_where("kgimprovement_result_details",array('student_id'=>$student_id,'header_id'=>'6'))->row();
