...
class LowerMiddle_Reportcard extends CI_Controller {
  ...
  function rpcardsfront() {
	   ...
	   $data["reportcard_subject"]=$this->db->order_by("id","ASC")->get_where("reportcard_subject",array("level"=>"lowermiddle"));
	
			$this->load->view('layout/parent/header', $data);
				$this->load->view('parent/reportcard/lowermiddlereportcardFrontwithGrades', $data);
				$this->load->view('layout/parent/footer', $data);
   }
    ...
    function rpcardsback() {
       ...
       $data["school_activity"]=$this->db->order_by("id","ASC")->get("school_activity");
        ...
        $this->load->view('parent/reportcard/lowermiddlereportcardBack', $data);
    }
