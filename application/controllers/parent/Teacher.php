...
class Teacher extends CI_Controller {
    ...
    function index() {
        ...
        $school = $sessionData['school'];//$this->customlib->getStudentSessionUserID();
  ...
  $query=$this->db->query("SElECT teachers.name,subjects.name as sname from  teachers
   RIGHT JOIN teacher_subjects ON teachers.id=teacher_subjects.teacher_id RIGHT JOIN 
         subjects ON subjects.id=teacher_subjects.subject_id
          WHERE teacher_subjects.class_section_id='$class_id'
          AND teacher_subjects.school='$school' ");
