...
class Teacherdiary_model extends CI_Model {
    ...
    public function get($id = null) {
        if ($id != null) {
           ...
           $this->db->select("teacherdiary.*,classes.class,sections.section,subjects.name as sname,teacherdiary_detail.description as tdes,teacherdiary_detail.subject_id,teacherdiary_detail.id as detail_id,teacherdiary_detail.month as month,teachers.name as teacher");
           ...
           $this->db->join("teachers",'teacherdiary.teacher_id=teachers.id',"left");
           $this->db->order_by("teacherdiary_detail.month");
           $this->db->where('teacherdiary.id',$id);


        } else {

           $this->db->select("teacherdiary.*,classes.class,sections.section,teachers.name as teacher");
           $this->db->join("classes",'teacherdiary.class_section_id=classes.id');
           $this->db->join("sections",'teacherdiary.section_id=sections.id');
           $this->db->join("teachers",'teacherdiary.teacher_id=teachers.id');
           $this->db->order_by("teacherdiary.created_at,teacherdiary.id");
 ...
 function getByeachTeacher($teacher_id)
    ...
    public function remove($id) {
        ...
        $this->db->delete('teacherdiary_detail');
    }
