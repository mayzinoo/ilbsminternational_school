...
class Meetingminutes_model extends CI_Model {
    ...
    public function get($id = null) {
        if ($id != null) {
           ...
           $this->db->select("dailyrecord.*,classes.class,sections.section,subjects.name as sname,dailyrecord_detail.description as tdes,dailyrecord_detail.subject_id,dailyrecord_detail.id as detail_id");
        ...
        $query = $this->db->get("meetingminutes");
        if ($id != null) {
            return $query;
        } else {
