...
class Qualification_model extends CI_Model {
    ...
    function get($id = null)
    {
        if($id==null)
        {                                 
        $query=$this->db->query("SELECT qualification.*, subjects.name as name FROM qualification LEFT JOIN subjects ON qualification.subject=subjects.id");                  
        return $query->result_array();
        }

        else
        {            
        $query=$this->db->query("SELECT qualification.*, subjects.name as name FROM qualification LEFT JOIN subjects ON qualification.subject=subjects.id WHERE qualification.id='$id'");        
        return $query;
        }
    }
