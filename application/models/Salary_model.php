...
class Salary_model extends CI_Model {
    ...
    public function search($location=null,$text = null, $start_date = null, $end_date = null) {
        ...
        if (!empty($location)) {
            $this->db->select("sch_settings.name as ltext,teachers.name as tname,salary.*");
            $this->db->join('teachers', 'teachers.id = salary.teacher_id',"RIGHT");
            $this->db->join("sch_settings","teachers.location=sch_settings.id","INNER");
        ...
        if (!empty($text)) {
            ...
            $this->db->join("sch_settings","sch_settings.id=teachers.location");
