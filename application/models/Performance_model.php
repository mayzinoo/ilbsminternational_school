...
class Performance_model extends CI_Model {
    ...
    function get($id = null)
    {
        if($id==null)
        {                                 
        $query=$this->db->query("SELECT performance.*,teachers.name as name,teachers.position as position, teachers.educationDepartment as dept,teachers.startDateofTeaching as join_date FROM performance LEFT JOIN teachers ON performance.teacher_id=teachers.id");                  
        return $query->result_array();
        }

        else
        {            
        $query=$this->db->query("SELECT performance.*,teachers.name as name,teachers.position as position, teachers.educationDepartment as dept,teachers.startDateofTeaching as join_date FROM performance LEFT JOIN teachers ON performance.teacher_id=teachers.id WHERE performance.id='$id'")->row();        
        return $query;
        }
    }
    ...
    function getPerformanceType()
		   {
				...
				$query = $this->db->get("performance_type");
