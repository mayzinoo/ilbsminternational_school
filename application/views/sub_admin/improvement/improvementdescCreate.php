        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    ...
                    <form id="form1" action="<?php echo base_url() ?>teacher/improvement/Improvementdesc/create"  id="improvement" name="improvement" method="post" enctype="multipart/form-data" accept-charset="utf-8">
                        <div class="box-body">
                           ...
                           <div class="col-md-2"></div>
                            ...
                            ?>">
                               ...
                               <?php echo form_dropdown("rank",array("International Primary School (Lower)"=>"International Primary School (Lower)","International Primary School (Upper)"=>"International Primary School (Upper)"),'','class="form-control"'); ?>
