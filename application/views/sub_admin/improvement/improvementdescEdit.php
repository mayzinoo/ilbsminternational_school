            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title"><?php //echo $title;     ?>Add New Improvement Description</h3>
                    </div><!-- /.box-header -->
                    <form id="form1" action="<?php echo site_url('teacher/improvement/Improvementdesc/edit/' . $id) ?>"  id="improvement" name="improvement" method="post" enctype="multipart/form-data" accept-charset="utf-8">
                        <div class="box-body">
                           ...
                           <div class="col-md-2"></div>
                            ...
                            ?>">
                               ...
                               <?php echo form_input("lesson_title",$show->lessontitle,'class="form-control"'); ?>
                            ...
                            ?>">
                               ...
                               <?php echo form_dropdown("rank",array("International Primary School (Lower)"=>"International Primary School (Lower)","International Primary School (Upper)"=>"International Primary School (Upper)"),$show->rank,'class="form-control"'); ?>
