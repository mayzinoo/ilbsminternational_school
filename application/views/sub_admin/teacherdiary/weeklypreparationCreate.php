        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    ...
                    <form id="form1" action="<?php echo base_url() ?>teacher/teacherdiary/Weeklypreparation/create"  id="weeklypreparation" name="weeklypreparation" method="post" enctype="multipart/form-data" accept-charset="utf-8">
                        <div class="box-body">
                           ...
                           <!--  <div class="col-md-2">
                            ...
                            ?>">
                               ...
                               <?php echo form_dropdown("teacher",$teacherlists,$teacher_id,'class="form-control" readonly'); ?>
