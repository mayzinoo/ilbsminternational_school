            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title"><?php //echo $title;     ?>Edit Teaching Notes</h3>
                    </div><!-- /.box-header -->
                    <form id="form1" action="<?php echo site_url('teacher/teacherdiary/Teachingnote/edit/' . $id) ?>"  id="teachingnote" name="teachingnote" method="post" enctype="multipart/form-data" accept-charset="utf-8">
                        <div class="box-body">
