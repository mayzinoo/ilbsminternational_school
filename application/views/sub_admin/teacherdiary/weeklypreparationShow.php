...
<h1>
<i class="fa fa-mortar-board"></i> Weekly Preparation <small><?php echo $this->lang->line('student_fees1'); ?></small>
</h1>
</section>
<!-- Main content -->
   ...
   <div class="col-md-12">
                ...
                <div class="box box-primary">
                    <div class="box-header ptbnull">
                        <h3 class="box-title titlefix">Weekly Preparation</h3>
                        <div class="box-tools pull-right">
                        </div><!-- /.box-tools -->
                    </div><!-- /.box-header -->
                    <div class="box-body">
                        <div class="table-responsive mailbox-messages">
                            <div class="download_label">Weekly Preparation</div>
                            <table class="table table-striped table-bordered table-hover example">
                                 ...
                                 <tr>
                                 	<td colspan="3"><h3>တစ္ပတ္စာ ၾကိဳတင္ျပင္ဆင္ခ်က္</h3></td>
                                 </tr>
                                    <tr>
                                        <th>Subjects
                                        </th>
                                        ...
                                        <tr>
                                          <td class="mailbox-name">
                                           ...
                                           <td class="mailbox-date pull-right">
                                                <a href="<?php echo base_url(); ?>teacher/teacherdiary/Weeklypreparation/view/<?php echo $expense->id ?>" class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('show'); ?>" >
                                                    <i class="fa fa-reorder"></i>
                                                </a>
                                                <a href="<?php echo base_url(); ?>teacher/teacherdiary/Weeklypreparation/edit/<?php echo $expense->id ?>" class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('edit'); ?>">
                                                    <i class="fa fa-pencil"></i>
                                                </a>
                                                <a href="<?php echo base_url(); ?>teacher/teacherdiary/Weeklypreparation/delete/<?php echo $expense->id ?>"class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="return confirm('Are you sure you want to delete this item?')";>
