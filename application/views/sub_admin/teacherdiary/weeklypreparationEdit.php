            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                     ...
                     <form id="form1" action="<?php echo site_url('teacher/teacherdiary/Weeklypreparation/edit/' . $id) ?>"  id="teacherdiary" name="teacherdiary" method="post" enctype="multipart/form-data" accept-charset="utf-8">
                        <div class="box-body">
