...
<form id="form1" action="<?php echo base_url() ?>teacher/teacherdiary/Teachingnote/create"  id="teachingnote" name="teachingnote" method="post" enctype="multipart/form-data" accept-charset="utf-8">
<div class="box-body">
