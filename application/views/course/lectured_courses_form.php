            ...
            <div class="col-md-12">           
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title">Add New Lecture Course</h3>
                    </div> 
                    <form id="form1" action="<?php echo site_url('Course/create_course') ?>" name="employeeform" method="post" accept-charset="utf-8"  enctype="multipart/form-data">
                        <div class="box-body">
                           ...
                           <div class="form-group col-md-6">
                                ...
                                <?=form_dropdown("teacher",$teacherlist,"","class='form-control'")?>
                                <span class="text-danger"><?php echo form_error('teacher'); ?></span>
                            </div>
                            
                            <div class="form-group col-md-6">
                                <label for="exampleInputEmail1">Start Date</label>
                                <input autofocus="" id="start_date" name="start_date" placeholder="choose date" type="text" class="form-control"  value="<?php echo set_value('start_date'); ?>" />
                                <span class="text-danger"><?php echo form_error('start_date'); ?></span>
                            </div>
                            
                            <div class="form-group col-md-6">
                                <label for="exampleInputEmail1">End Date</label>
                                <input autofocus="" id="end_date" name="end_date" placeholder="choose date" type="text" class="form-control"  value="<?php echo set_value('end_date'); ?>" />
                                <span class="text-danger"><?php echo form_error('end_date'); ?></span>
                            </div>
                            
                            <div class="form-group col-md-6">
                                <label for="exampleInputEmail1">Duration</label>
                                <input autofocus="" name="duration" placeholder="Duration" type="text" class="form-control"  value="<?php echo set_value('duration'); ?>" />
                                <span class="text-danger"><?php echo form_error('duration'); ?></span>
                            </div>
                            
                            <div class="form-group col-md-6">
                                <label for="exampleInputEmail1">Certificate</label>
                                <input autofocus="" name="certificate" placeholder="certificate" type="text" class="form-control"  value="<?php echo set_value('certificate'); ?>" />
