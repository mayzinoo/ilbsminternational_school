<div class="content-wrapper" style="min-height: 330px;">
    <section class="content-header">
        <h1>
            <i class="fa fa-user-plus"></i> Create System Settings     </h1>
    </section>
    <section class="content">
    <div class="col-md-12">
        <div class="box box-primary">
            <div class="box-header ptbnull">
            <?=form_open('Schsettings/schsetting_insert/')?>
            <div class="box-header ptbnull">
            ...
            <div class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-6">
                    ...
                    <input class="form-control" id="name" name="sch_name" placeholder="" type="text" value=""  />
            ...
            <div class="col-md-3">
                        ...
                        <br/>
                        <br/>
                        <a href="#schsetting" role="button" class="btn btn-primary btn-sm upload_logo" data-toggle="tooltip" title="Upload Logo" data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> Processing"><i class="fa fa-picture-o"></i> Upload Logo</a>
