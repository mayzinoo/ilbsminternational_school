        ...
        <div class="row">
            <div class="col-md-4">
                <div class="box box-primary">
                    ...
                    <form action="<?php echo site_url('inter_class/index') ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8">
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <input autofocus="" id="class" name="class" placeholder="" type="text" class="form-control"  value="<?php echo set_value('section'); ?>" />
