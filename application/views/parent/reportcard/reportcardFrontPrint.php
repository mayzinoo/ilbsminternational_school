...
<?=anchor("admin/Reportcard/rpcardsback/".$student["id"],"&laquo; Back Report","class='btn active'");?>

<?=anchor("admin/Reportcard/printwithgrade/".$student["id"],"&laquo; Grades","class='btn active'");?>
...
<div class="row header">
                         ...
                         <img src="<?php echo base_url(); ?>uploads/school_content/logo/<?php echo $settinglist->left_logo; ?>" width="110%">                                 
                            ...
                            <div class="col-sm-6  lower">
                                <strong class="title"><?php echo $settinglist->title; ?></strong>
