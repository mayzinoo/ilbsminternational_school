...
<div class="content-wrapper" style="min-height: 946px;">
    <section class="content-header">
        <h1>
            <i class="fa fa-user-plus"></i> My Children</h1>
    </section>
            ...
            <div class="col-md-9">
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs">
                        <li class="active"><a href="#activity" data-toggle="tab" aria-expanded="true"><?php echo $this->lang->line('profile'); ?> Information Details</a></li>
                                ...
                                <div class="table-responsive around10 pt10">
                                    <table class="table table-hover table-striped tmb0">
                                        ...
                                        <tr>
                                            ...
                                            <td id="hidemb">
                                        <input type="text" onblur="updatephone(this.value,'<?=$student[id]?>')" value="<?php echo $student['guardian_phone']; ?>">
                                            </span>
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td id="hidead">
                                            <input type="text" style="width:400px;" onblur="updateaddress(this.value,'<?=$student[id]?>')" value="<?php echo $student['guardian_address']; ?>"> 
                                            </td>
                                        </tr>
