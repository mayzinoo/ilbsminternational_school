                                ...
                                <tbody>
                                    ...
                                    foreach ($lists as $expense) {
                                        ...
                                        <tr>
                                               ...
                                               <td class="mailbox-name">
   <a href="<?php echo base_url(); ?>parent/Parents/viewdailyrecord/<?php echo $expense['id'] ?>" class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('show'); ?>" >
