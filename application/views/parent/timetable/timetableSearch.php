                                    ...
                                    <table class="table table-bordered example">
                                        <thead>
                                            <tr>
                                                ...
                                                ?>
                                                <th class="cdata">
                                                    <div style="margin-top:1px;margin-bottom:1px;"><?php echo $time->$start;?></div> -
                                                    <div style="margin-top:1px;margin-bottom:1px;"><?php echo $time->$end; ?></div>
                                                </th>    
                                                <?php
                                                }
                                                } ?>
