                                            ...
                                            <?php $c=1;
                                                ...
                                                <tr>
                                                  ...
                                                  <td>
                                                    ...
                                                    <td>
                                                        <a href="<?php echo base_url(); ?>parent/Timetable/viewdetail/<?=$list->id?>/<?php echo $list->class_id ?>/<?=$list->section_id?>" class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('show'); ?>" >
