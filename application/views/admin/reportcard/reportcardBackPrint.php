...
<?=anchor("admin/High_Reportcard/rpcardsfront/".$student["id"],"&laquo; Front Report","class='btn active pull-right'");?>
<?=anchor("admin/High_Reportcard/rpcardsbackwithgrades/".$student["id"],"&laquo; Grades","class='btn active'");?>
...
$no=0;
 $r=$rpcards->row();
 ?>
<td align="center"><?php    echo $r->act_1?></td>
<td align="center"><?php    echo $r->act_2?></td>
<td align="center"><?php    echo $r->act_3?></td>
<td align="center"><?php    echo $r->act_4?></td>
<td align="center"><?php    echo $r->act_5?></td>
<td align="center"><?php    echo $r->act_6?></td>
<td align="center"><?php    echo $r->act_7?></td>
<td align="center"><?php    echo $r->act_8?></td>
<td align="center"><?php    echo $r->act_9?></td>
