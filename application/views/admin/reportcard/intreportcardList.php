        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    ...
                    <form action="<?php echo site_url('admin/Inter_Reportcard') ?>"  method="post" accept-charset="utf-8" id="schedule-form">
                        <div class="box-body">
                            <div class="row">
                ...
                if (isset($examSchedule['status'])) {
                    ...
                    <div class="box box-info">
                        <div class="box-header with-border">
                            <h3 class="box-title">
                                <i class="fa fa-list"></i> Inter Report Card Lists</h3>
                        </div>
                        <div class="box-body">
                            <?php
                            if ($examSchedule['status'] == "yes") {
                                ...
                                <form role="form" id="" class="" method="post" action="<?php echo site_url('admin/Inter_Reportcard/create') ?>">
                                    <?php echo $this->customlib->getCSRF(); ?>
