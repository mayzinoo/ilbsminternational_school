...
<?=anchor("admin/Middle_Reportcard/rpcardsback/".$student["id"],"&laquo; Back Report","class='btn active'");?>

<?=anchor("admin/Middle_Reportcard/printwithgrade/".$student["id"],"&laquo; Grades","class='btn active'");?>
...
<div class="row header">
                         ...
                         <img src="<?php echo base_url(); ?>uploads/school_content/logo/<?php echo $settinglist->left_logo; ?>" width="110%">                                 
                            ...
                            <div class="col-sm-7  lower">
                                ...
                                <strong class="sectitle"><?php echo $settinglist->title; ?> <?php echo $settinglist->level?> ဆင့္ </strong>
