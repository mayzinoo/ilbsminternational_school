                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="row">
                                    <form role="form" action="<?php echo site_url('admin/High_Reportcard/search') ?>" method="post" class="">
...
<a href="<?php echo base_url(); ?>admin/<?=$student['level']?>_Reportcard/rpcardsfront/<?php echo $student['id'] ?>" class="btn btn-default btn-xs"  data-toggle="tooltip" title="Exam Report Card (Front)" target="_blank" >
