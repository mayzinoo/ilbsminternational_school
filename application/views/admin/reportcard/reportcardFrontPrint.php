...
<?=anchor("admin/High_Reportcard/rpcardsback/".$student["id"],"&laquo; Back Report","class='btn active'");?>

<?=anchor("admin/High_Reportcard/printwithgrade/".$student["id"],"&laquo; Grades","class='btn active'");?>
