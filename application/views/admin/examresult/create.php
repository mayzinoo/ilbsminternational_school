...
<h1>
<i class="fa fa-credit-card"></i> Exam Results Form<small></small>        </h1>
</section>
...
<form id="form1" action="<?php echo base_url() ?>admin/Examresult/search_student"  id="improvement" name="improvement" method="post" enctype="multipart/form-data" accept-charset="utf-8">
<div class="box-body">
...
<div class="box-header with-border">
<h3 class="box-title"><?php //echo $title;     ?>Add New Exam Results</h3>
</div><!-- /.box-header -->
<div class="row box-body">
<div class="box-info with-border">
<?php echo form_open("admin/Examresult/result_insert")?>
<input type="hidden" name="class" value="<?php echo $this->session->userdata('class'); ?>">
<input type="hidden" name="section" value="<?php echo $this->session->userdata('section'); ?>">
<div class="col-md-2">
    <div class="form-group">
     <label>Academic Year</label>
     <?php echo form_dropdown("session",$sessionlists,"",'class="form-control"'); ?>
    </div>
</div>
<div class="col-md-2">
    <div class="form-group">
...
<div class="col-md-2">
    <div class="form-group">
     <label>School</label>
     <?php echo form_dropdown("school",$school,"",'class="form-control"'); ?>
    </div>
</div>
...
<th>Exam Seat Number</th>
  ...
  <input type="hidden" name="admission_no[]" value="<?=$stulist['admission_no']?>">
  <input type="hidden" name="student[]" value="<?=$stulist['id']?>">
  <input type="hidden" name="father[]" value="<?=$stulist['father_name']?>">
