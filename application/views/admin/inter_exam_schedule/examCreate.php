...
<div class="content-wrapper" style="min-height: 946px;">
    ...
    <!-- Main content -->
       ...
       <form id="form1" action="<?php echo base_url() ?>admin/Inter_examSchedule/create"  id="examsch" name="examsch" method="post" enctype="multipart/form-data" accept-charset="utf-8">
                ...
                <div class="box box-primary">
                    ...
                    <div class="box box-info">
                        ...
                        <div class="box-body">
                              ...
                              <tr class="clonethis">
                                                    <td>
                                             <?php echo form_dropdown("subject_id[]",$subjectlists,set_value("subject_id"),"class='form-control'");?>
                                                    ...
                                                    <td>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="date[]" class="form-control sandbox-container"  placeholder="Enter date" value="<?php echo $exam_date; ?>">
                                                        </div>
                                                    </td>
                                                        ...
                                                        <div class="bootstrap-timepicker">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="input-group">
                                                                    <input type="text" name="stime[]" class="form-control timepicker"  value="<?php echo $exam_time; ?>">
                                                    ...
                                                    <td style="width:200px;">
                                                        <div class="bootstrap-timepicker">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="input-group">
                                                                    <input type="text" name="etime[]" class="form-control timepicker"  value="<?php echo $value['end_from'] ?>">
                                                                    <div class="input-group-addon">
                                                                        <i class="fa fa-clock-o"></i>
                                                                    </div>
                                                                </div><!-- /.input group -->
                                                    ...
                                                    <td>
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="room[]" class="form-control"   value="<?php echo $value['room_no'] ?>" placeholder="Enter Room">
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="form-group">

                                                            <input type="text" name="fmark[]" class="form-control"  value="<?php echo $value['full_marks'] ?>" placeholder="Enter Full Marks">
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="form-group">

                                                            <input type="text" name="pmarks[]" class="form-control"  value="<?php echo $value['passing_marks'] ?>" placeholder="Enter Passing Marks">
                                                        </div>
                                                    </td>
