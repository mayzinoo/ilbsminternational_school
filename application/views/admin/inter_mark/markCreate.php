        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    ...
                    <form action="<?php echo site_url('admin/Inter_mark/create') ?>"  method="post" accept-charset="utf-8" id="schedule-form">
                        <div class="box-body">
                            ...
                            <button type="submit" class="btn btn-primary pull-right" name="save_exam"><i class="fa fa-search"></i> <?php echo $this->lang->line('search'); ?></button>
                        </div>
                                </div><!-- /.col -->
                    ...
                    <div class="box box-info">
                        ...
                        <div class="box-body">
                            ...
                            if (!empty($examSchedule)) {
                                ?>
                                <form role="form" id=""  class="addmarks-form"  method="post" action="<?php echo site_url('admin/Inter_mark/create') ?>">
                                    <?php echo $this->customlib->getCSRF(); ?>
                                    <input type="hidden" name="inter_class" value="<?php echo $inter_class; ?>">
                                                ...
                                                if (!empty($student['exam_array'])) {
                                                    if ($s == 0) {
                                                        foreach ($student['exam_array'] as $key => $exam_schedule) {
                                                            ...
                                                            <input type="hidden" name="sid[]" value="<?php echo $exam_schedule['sid'] ?>">
                                                            <input type="hidden" name="full_marks[]" value="<?php echo $exam_schedule['full_marks'] ?>">
                                                            <?php
                                                        }
                                                    }
                                                } else {
                                                        ...
                                                        foreach ($student['exam_array'] as $key => $exam_schedule) {
                                                            ...
                                                            <td>
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" name="student_number<?php echo $student['student_id']; ?>_<?=$exam_schedule['sid']?>" class="form-control input-sm" id="subject_<?php echo $student['student_id'] . "_" . $exam_schedule['exam_schedule_id']; ?>" value="<?php echo $exam_schedule['get_marks'] ?>" placeholder="Enter Marks">
                                                                </div>
                                                            </td>
                                                            <?php
                                                        }
