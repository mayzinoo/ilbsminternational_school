...
<div class="content-wrapper" style="min-height: 946px;">  
    <section class="content-header">
        <h1>
            <i class="fa fa-user-plus"></i> Students' Leave Information <small></small></h1>
    </section>
    <!-- Main content -->
                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                <div class="row">
                                    <form role="form" action="<?php echo site_url('admin/Leaveuser/leaveform') ?>" method="post" class="">
                    ...
                    <div class="nav-tabs-custom">
                        ...
                        <div class="tab-content">
                            ...
                            <?=form_open('admin/Leaveuser/leavestu_insert/')?>
...
<input type="hidden" name="student_id[]" value="<?=$student['id']?>"/>
  ...
  <input type="hidden" name="session" value="<?=$student['sessid']?>">
                                        ...
                                        <td>
                                            <input type="text" name="leavefrom[]" id="start_date" class="form-control">
                                        </td>
                                        <td>
                                            <input type="text" name="leaveto[]" id="end_date" class="form-control">
                                        </td>
                                        <td>
