...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            <i class="fa fa-credit-card"></i> School Holidays  <small class="pull-right"><?=anchor("admin/School_calendar/createform","+ Add","class='btn btn-primary btn-sm'")?></small></h1>
    </section>
				...
				-->	
                    ...
                    <div class="box box-info">
                        <div class="table-responsive mailbox-messages">
                            <div class="download_label">School Holidays</div>
                            <table class="table table-hover table-striped table-bordered example">
                               ...
                               <tbody>
                                        ...
                                        foreach ($holidaylist as $holiday) {
                                            ...
                                            <td><?=$no?></td>                                 
                                                <td class="mailbox-name">
                                                 ...
                                                 <td class="mailbox-name">
                                                    <?php echo $holiday['datefrom'] ?>
                                                </td>
                                                <td class="mailbox-name">
                                                    <?php echo $holiday['dateto'] ?>
                                                </td>
                                                <td class="mailbox-name">
                                                    <?php echo $holiday['total']?>                 
                                                </td>
                                                 <td class="mailbox-name">
                                                  ...
                                                  <td class="mailbox-name">
                                        <a href="<?php echo base_url(); ?>admin/Holiday/edit_form/<?php echo $holiday['id']?>" class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('edit'); ?>">
                                            <i class="fa fa-pencil"></i>
                                        </a>
                                        <a href="<?php echo base_url(); ?>admin/Holiday/delete/<?php echo $holiday['id']?>" class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="return confirm('Are you sure you want to delete this item?')";>
                                    ...
                                    <!-- <tr><td colspan="4"></td><td><?=number_format($total)." ".$holiday["currency"]?></td></tr> -->
