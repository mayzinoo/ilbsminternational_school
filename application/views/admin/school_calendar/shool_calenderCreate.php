...
<h3 class="box-title">New School Calendar Form</h3>
</div><!-- /.box-header -->
<form id="form1" action="<?php echo site_url() ?>admin/School_calendar/create_calendar" name="School_calendar" method="post" enctype="multipart/form-data" accept-charset="utf-8">
<div class="box-body">
...
<div class="form-group">
        ...
        <input id="att_day" name="att_day" placeholder="" type="text" class="form-control"  value="<?php echo set_value('datefrom'); ?>"  />
     </div>
