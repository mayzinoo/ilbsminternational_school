...
<?=anchor("admin/Reportcard/rpcardsfront/".$student["id"],"&laquo; Marks","class='btn active pull-right'");?>
...
<div class="row header">
                            <div class="col-sm-1">                               
                         <img src="<?php echo base_url(); ?>/backend/images/<?php echo $settinglist->left_logo; ?>" width="110%">                                 
                            </div>
