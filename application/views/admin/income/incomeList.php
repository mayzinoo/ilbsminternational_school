...
<div class="content-wrapper">
            ...
            <div class="col-md-8">
                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        ...
                        <form role="form" action="<?php echo site_url('admin/income/incomeSearch_list') ?>" method="post" class="">
                                        <?php echo $this->customlib->getCSRF(); ?>
                                        <div class="col-sm-6">
                                            <div class="form-group">
                ...
                <div class="box box-info">
                        <div class="box-header with-border">
                            <h3 class="box-title"><i class="fa fa-users"></i> Stock List </h3>
                            <div class="box-tools pull-right">
                            </div>
                        </div>
                        <div class="box-body">    
 ...
 <a href="<?php echo base_url(); ?>admin/income/download/<?php echo $income['documents'] ?>" class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('download'); ?>">
    ...
    <td colspan="2">K<?php echo $total; ?></td>
</tr>
                            </table><!-- /.table -->
                </div>
                </div>
