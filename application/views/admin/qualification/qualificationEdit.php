...
<div class="content-wrapper">
            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title"><?php //echo $title;     ?>Edit Qualification</h3>
                    </div><!-- /.box-header -->
                    <form id="form1" action="<?php echo site_url('admin/Qualification/edit/' . $id) ?>"  id="teacherdiary" name="teacherdiary" method="post" enctype="multipart/form-data" accept-charset="utf-8">
                        <div class="box-body">
                            ...
                            ?>">
                               ...
                               <?php echo form_dropdown("subject[]",$subjectlists,$list->subject,'class="form-control"'); ?>
  ...
  <div class="form-group <?php
                            ...
                            ?>">
                                <textarea class="form-control" name="description[]" placeholder="" rows="3" placeholder="Enter ..."><?php echo set_value('description',$list->qualification); ?></textarea>
