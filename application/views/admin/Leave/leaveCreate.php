        ...
        <div class="row">       
            <div class="col-md-12">           
                <div class="box box-primary">
                    ...
                    <form id="form1" action="<?php echo site_url('admin/Leave/insert_leave') ?>"  id="leave_form" name="employeeform" method="post" accept-charset="utf-8"  enctype="multipart/form-data">
                        <div class="box-body">
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <input autofocus="" id="leavefrom" name="leavefrom" placeholder="" type="text" class="form-control"  value="<?php echo set_value('leavefrom'); ?>" />
                                <span class="text-danger"><?php echo form_error('leavefrom'); ?></span>
                            </div>

                            <div class="form-group col-md-3">
                                <label for="exampleInputEmail1">Leave To</label>
                                <input autofocus="" id="leaveto" name="leaveto" placeholder="" type="text" class="form-control"  value="<?php echo set_value('leaveto'); ?>" />
                                <span class="text-danger"><?php echo form_error('leaveto'); ?></span>
                            </div>
                            
                            <div class="form-group col-md-3">
                                <label for="exampleInputEmail1">Leave Total</label>
                                <input autofocus="" id="leavetotal" name="leavetotal" placeholder="" type="text" class="form-control"  value="<?php echo set_value('leavetotal'); ?>" />
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <br/>
                                <input type="radio" value="casual" name="leavetype"> ေရွာင္တခင္ခြင့္    &nbsp;  <input type="radio" value="earn" name="leavetype"> လုပ္သက္ခြင့္    &nbsp;  <input type="radio" value="medical" name="leavetype"> ေဆးလက္မွတ္ခြင့္    &nbsp;  <input type="radio" value="compensation" name="leavetype"> သာေရးနာေရးခြင့္    &nbsp;  <input type="radio" value="paternity" name="leavetype"> မီးဖြားခြင့္    &nbsp;  <input type="radio" value="maternity" name="leavetype"> ဖခင္ဘ၀ခံစားခြင့္    &nbsp;  <input type="radio" value="other" name="leavetype"> အျခားခြင့္    &nbsp; 
                                    <input type="radio" value="replace" name="leavetype"> ရက္အစားခြင့္ (တိက်စြာေဖာ္ျပရမည္။)    
                           ...
                           <div class="form-group col-md-12">
                                ...
                                <!--    <input autofocus="" size='20' id="apply_by" name="apply_by" type="file" class="form-control filestyle" value="<?php echo set_value('apply_by'); ?>" />-->
                                <!--</div>-->
    
                                <div class="col-md-4">
                                    <label for="leavedate">Apply Date</label>
                                    <input autofocus="" id="leavedate" name="leave_date" placeholder="" type="text" class="form-control"  value="<?php echo set_value('leave_date'); ?>" />
                                ...
                                <div class="col-md-4">
                                    ...
                                    <!--<input autofocus="" id="category" name="name" placeholder="" type="text" class="form-control"  value="<?php echo set_value('name'); ?>" />-->
                                    <?php echo form_dropdown("dtransfer",$teacherlists,'','class="form-control"'); ?>
                            ...
                            <div class="form-group col-md-5">
                                ...
                                လစာျဖင့္ <input autofocus="" name="adbysalary" placeholder="" type="radio" class="form-control-date"  value="yes" /> &nbsp; &nbsp;
                                လစာမဲ့ျဖင့္ <input autofocus="" name="adbysalary" placeholder="" type="radio" value="no" class="form-control-date" />
                                ...
                                <textarea name="remark" class="form-control"></textarea> <br/>
                                 ...
                                 <input type="radio" value="yes" name="recbyadmin">&nbsp; ေထာက္ခံသည္ &nbsp; &nbsp; &nbsp; 
                                 <input type="radio" value="no" name="recbyadmin">&nbsp; မေထာက္ခံပါ &nbsp; &nbsp; &nbsp;  <br/> <br/>
                            ...
                            <div class="form-group col-md-6">
                               ...
                               ခြင့္လက္က်န္ <br/>
                               <input type="radio" value="casual" name="hrleavebalance">&nbsp; ေရွာင္တခင္ခြင့္ &nbsp; &nbsp; &nbsp; 
                               <input type="radio" value="earn" name="hrleavebalance">&nbsp; လုပ္သက္ခြင့္ &nbsp; &nbsp; &nbsp;  
                               <input type="radio" value="medical" name="hrleavebalance">&nbsp; ေဆးခြင့္ &nbsp; &nbsp; &nbsp; 
                               <input type="radio" value="other" name="hrleavebalance">&nbsp; အျခားခြင့္ &nbsp; &nbsp; &nbsp;
                               
                               <br/> <br/>
                               
                               
                                     <input type="radio" value="hrbysalary" name="hrbysalary">&nbsp; လစာျဖင့္ခြင့္ျပဳသည္ &nbsp; &nbsp; &nbsp; <input type="radio" value="nosalary" name="hrbysalary">&nbsp; လစာမဲ့ျဖင့္ခြင့္ျပဳသည္ &nbsp; &nbsp; &nbsp; <input type="radio" value="noapprove" name="hrbysalary">&nbsp; ခြင့္မျပဳပါ &nbsp; &nbsp; &nbsp;  <br/> <br/> <br/> <br/> <br/>
                            ...
                            <div class="col-md-12 text-center">
                                ...
                                <input type="radio" value="allow" name="approve_status">&nbsp; သေဘာတူသည္ &nbsp; &nbsp; &nbsp; <input type="radio" value="notallow" name="approve_status">&nbsp; သေဘာမတူပါ &nbsp; &nbsp; &nbsp; <br/> <br/>
