...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            <i class="fa fa-credit-card"></i> Purchase  <small class="pull-right"><?=anchor("admin/Purchase/createform","+ Add","class='btn btn-primary btn-sm'")?></small></h1>
    </section>
                                        ...
                                        foreach ($purchaselist as $purchase) {
                                            ...
                                            <td><?=$no?></td>                                 
                                                <td class="mailbox-name">
                                                    <?php echo $purchase['requested_by'] ?>
                                                </td>
                                                 <td class="mailbox-name">
                                                    <?php echo $purchase['requested_school'] ?>
                                                </td>
                                                <td class="mailbox-name">
                                                    <?php echo $purchase['form_no'] ?>
                                                </td>
                                                <td class="mailbox-name">
                                                  ...
                                                  <td class="mailbox-name">
                                                      <?=anchor("admin/Purchase/edit_form/".$purchase['id'],"<i class='fa fa-edit'></i> ","")?>     
                                                    <?=anchor("admin/Purchase/view_detail/".$purchase['id'],"/ Detail","target='_blank'")?>
                                                    </td>
