        ...
        if (empty($resultlist)) {
            ...
            foreach ($resultlist as $student) {
                ...
                <tr class="<?php echo $clsactive; ?>">
                    ...
                    <td id="status<?=$student['id']?>"><?php echo $library_card_no; ?></td>
...
<div class="modal-dialog modal-sm">
        <?=form_open("Member/member_edit/", "id='form".$student['id']."'")?>
      ...
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-default" data-dismiss="modal" onclick="member_edit('<?=$student["id"]?>')">Save</button>
        </div>
      </div>
      <?=form_close()?>
    </div>
     ...
     <a href="<?php echo base_url(); ?>admin/Member/member_delete/<?php echo $student["id"]?>"class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="return confirm('Are you sure you want to delete this item?')";>
