...
<div class="content-wrapper" style="min-height: 946px;">  
    <section class="content-header">
        <h1>
            <i class="fa fa-mortar-board"></i> Messages From ILBSM Website </h1>
    </section>
    <!-- Main content -->
            ...
            <div class="col-md-12">              
                <div class="box box-primary" id="tachelist">
                    <div class="box-header ptbnull">
                        <h3 class="box-title titlefix">Message Lists</h3>
                                ...
                                <tbody>
                                    ...
                                    foreach ($lists->result() as $list) {
                                        ...
                                        <tr>
                                            ...
                                            <td class="mailbox-name"> <?php echo $list->email ?></td>
                                            <td class="mailbox-name"> <?=$list->subject?></td>
                                            <td class="mailbox-name"> <?php echo $list->message ?></td>
            									...
            									<div class="modal-content">
            										<div class="modal-header">
            											<button type="button" class="close" data-dismiss="modal">&times;</button>
            											 <h4 class="modal-title"><?=$list->subject?></h4> 
            										</div>
            										
            										<div class="modal-body">
            										    <?php echo form_open("admin/admin/mailreply/website_message"); ?>
