...
<div class="content-wrapper" style="min-height: 946px;">  
    <section class="content-header">
        <h1>
            <i class="fa fa-mortar-board"></i> Feedback <small><?php echo $this->lang->line('student_fees1'); ?></small></h1>
    </section>
    <!-- Main content -->
            ...
            <div class="col-md-12">              
                <div class="box box-primary" id="tachelist">
                    <div class="box-header ptbnull">
                        <h3 class="box-title titlefix"> Feedback Lists</h3>
                            ...
                            <table class="table table-striped table-bordered table-hover example">
                                ...
                                <tbody>
                                    ...
                                    foreach ($lists->result() as $list) {
                                        ...
                                        <tr>
                                            <td><?=$count?></td>
                                            <td class="mailbox-name"> <?php echo $list->guardian_name; ?></td>
                                            <td class="mailbox-name"> <?php echo $list->firstname.$list->lastname; ?></td>
                                            <td class="mailbox-name"> <?php echo $list->reply_by; ?></td>
                                            <td class="mailbox-name"> <?=$list->message?></td>
                                            <td class="mailbox-name"> <?php echo $list->date ?></td>
                                            <td>
                                            <?php if($list->reply_by=="")
                                            { ?>
            									...
            									<div class="modal-content">
            										<div class="modal-header">
            											<button type="button" class="close" data-dismiss="modal">&times;</button>
            											 <h4 class="modal-title">Reply For feedback of <?=$list->guardian_name?></h4> 
            										</div>
            										
            										<div class="modal-body">
            										    <?php echo form_open("admin/admin/mailreply/feedback"); ?>
