...
<h3 class="box-title"><?php //echo $title;     ?>New Performance Appraisal Form</h3>
</div><!-- /.box-header -->
<form id="form1" action="<?php echo site_url() ?>admin/Performance/create" name="perform" method="post" enctype="multipart/form-data" accept-charset="utf-8">
<div class="box-body">
...
<div class="row">
    ...
    <div class="col-md-2">
      <div class="form-group">
        ...
        <?php echo form_dropdown("teacher",$teachers,"","class='form-control'")?>
     </div>
    </div>
    ...
    <div class="col-md-2">
      <div class="form-group">
        ...
        <?php echo form_dropdown("approved_by",$teachers,"","class='form-control'")?>
     </div>
    </div>
...
<!--Header Row End-->
  ...
  <?php $i=1; foreach($performtype->result() as $ptype){ ?>
  <tr>
  <td class="no"><?=$i?></td>
