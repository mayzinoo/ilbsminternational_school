...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            <i class="fa fa-credit-card"></i> Performance Apraisal <small class="pull-right"><?=anchor("admin/Performance/createform","+ Add","class='btn btn-primary btn-sm'")?>    </small>
        </h1>
    </section>
                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="row">
                                    <form role="form" action="<?php echo site_url('admin/Performance/performanceSearch') ?>" method="post" class="">
                                        <?php echo $this->customlib->getCSRF(); ?>

                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <label>Teacher Name</label>
											<?php echo form_dropdown("teacher",$teacherlists,set_value("teacher"),"class='form-control'"); ?>
                                            </div>
                                        </div>
                                        ...
                                        foreach ($performanceresult as $performance) {
                                            ...
                                            <td><?=$no?></td>                                 
                                                <td class="mailbox-name">
                                                 ...
                                                 <td class="mailbox-name">
                                                    <?php echo $performance['position'] ?>
                                                </td>
                                                <td class="mailbox-name">
                                                    <?php echo $performance['dept'] ?>
                                                </td>
                                                <td class="mailbox-name">
                                                    <?php echo $performance['join_date']?>                 
                                                </td>

                                        <td class="mailbox-name action">
                                            <?=anchor("admin/performance/edit_form/".$performance['id'],"<i class='fa fa-edit'></i> / ","")?>
                                                    
                                        <a href="<?php echo base_url(); ?>admin/performance/delete/<?php echo $performance['id'] ?>" class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="return confirm('Are you sure you want to delete this item?')";>
                                        <i class="fa fa-remove"></i>
                                        </a>
                                        
                                                    <?=anchor("admin/performance/view_detail/".$performance['id'],"Detail","target='_blank'")?>
                                        </td>
