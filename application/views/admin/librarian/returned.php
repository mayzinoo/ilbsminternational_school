...
<li><a href="<?php echo base_url(); ?>admin/member/issue/<?=$memberList->lib_member_id?>" ><i class="fa fa-list"></i>  <h3 class="box-title titlefix"><?php echo $this->lang->line('book_issued'); ?> (ဖတ္ေနေသာ စာအုပ္မ််ား)</h3></a></li>
<li class="active"><a href="<?php echo base_url(); ?>admin/member/returned/<?=$memberList->lib_member_id?>" ><i class="fa fa-newspaper-o"></i>  <h3 class="box-title titlefix"> Book Returned (ဖတ္ျပီး စာအုပ္မ်ား)</h3></a></li>
</ul>
