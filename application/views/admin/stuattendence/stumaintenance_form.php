...
<form id='form1' action="<?php echo site_url('admin/Stuattendence/stumaintenance') ?>"  method="post" accept-charset="utf-8">
<div class="box-body">
...
<?=form_open("admin/Stuattendence/stumaintenance_insert")?>
