                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                       ...
                                       <input class="form-control" id="date" name="date" placeholder="" type="text"  value="<?php echo $att_date?>" /> <span class="text-danger"><?php echo form_error('date'); ?></span>
...
<li class="active"><a href="<?php echo base_url(); ?>admin/Stuattendence/classattendencereport" ><i class="fa fa-list"></i> Attendance Lists</a></li>

<li><a href="<?php echo base_url(); ?>admin/Stuattendence/classabsentreport" ><i class="fa fa-newspaper-o"></i> Absent Lists</a></li>
</ul>
                        <div class="box-body">
...
<td>
    ...
    <div class="modal-dialog modal-sm">
     ...
     <a href="<?php echo base_url(); ?>admin/Stuattendence/delete/<?php echo $student->id?>"class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="return confirm('Are you sure you want to delete this item?')";>
                ...
                function edit_attstatus(id)
                {
                    data=$("#form"+id).serialize();
                    		$.ajax({
                            		type:"POST",
                            		data: data,
                            		url:'<?php echo base_url() ?>admin/Stuattendence/edit',
                            		cache: false,
                            		success: function(d) 
