    ...
    <section class="content">       
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                         ...
                         <div class="col-md-4">
                            <div class="form-group">
                                <label>School</label>
                     <?php echo form_dropdown("school",$school,set_value("school"),"class='form-control' id='school'");?>

                                <span class="school_error text-danger"></span>
                            </div>
                        </div>
        ...
        <div class="box box-info" id="box_display" style="display:none">
            ...
            <form action="<?php echo base_url() ?>admin/teacher/assignteacher" method="POST" id="formSubjectTeacher">
                <?php echo $this->customlib->getCSRF(); ?>
                <br/>
                <input type="hidden" value="0" id="post_school_id" name="school">
