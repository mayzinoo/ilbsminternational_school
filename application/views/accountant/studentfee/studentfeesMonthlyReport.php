...
<h1>
<i class="fa fa-money"></i> <?php echo $this->lang->line('fees_collection'); ?> ( <?php echo strtoupper($for);?> )  <div class="box-tools pull-right">
                        <small class="pull-right"><?=anchor("accountant/Studentfee/studentfeesMonthlyreportPrint","<i class='fa fa-print'></i> Print","class='btn btn-primary btn-sm' target='_blank'")?></small> 
</div></h1> 
</section>
<!-- Main content -->
