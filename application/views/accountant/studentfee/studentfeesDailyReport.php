...
<i class="fa fa-money"></i> <?php echo $this->lang->line('fees_collection'); ?> ( <?php echo date("d-m-Y",strtotime($sel_day));?> )  <div class="box-tools pull-right">
                        <small class="pull-right"><?=anchor("accountant/Studentfee/studentfeesDailyreportPrint","<i class='fa fa-print'></i> Print","class='btn btn-primary btn-sm' target='_blank'")?></small> 
</div></h1> 
</section>
<!-- Main content -->
