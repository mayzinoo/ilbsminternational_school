...
<h1>
<i class="fa fa-money"></i> <?php echo $this->lang->line('fees_collection'); ?> ( <?php echo strtoupper($sel_year);?> )  <div class="box-tools pull-right">
                        <small class="pull-right"><?=anchor("accountant/Studentfee/studentfeesYearlyreportSearchPrint","<i class='fa fa-print'></i> Print","class='btn btn-primary btn-sm' target='_blank'")?></small> 
</div></h1> 
</section>
<!-- Main content -->
...
<div class="row">
<form role="form" action="<?php echo site_url('accountant/Studentfee/studentfeesYearlyreportSearch') ?>" method="post" class="">
...
?>
<?php echo form_dropdown("year",$year,set_value('year',date("Y")),'class="form-control"');?>
