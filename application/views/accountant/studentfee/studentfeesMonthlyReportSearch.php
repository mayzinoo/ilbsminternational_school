...
<h1>
<i class="fa fa-money"></i> <?php echo $this->lang->line('fees_collection'); ?> ( <?php echo strtoupper($month_sel);?> )  <div class="box-tools pull-right">
                        <small class="pull-right"><?=anchor("accountant/Studentfee/studentfeesMonthlyreportSearchPrint","<i class='fa fa-print'></i> Print","class='btn btn-primary btn-sm' target='_blank'")?></small> 
</div></h1> 
</section>
<!-- Main content -->
...
<div class="row">
<form role="form" action="<?php echo site_url('accountant/Studentfee/studentfeesMonthlyreportSearch') ?>" method="post" class="">
...
<?php echo form_dropdown("payment_for",$monthlist,set_value('payment_for',$sel_month),'class="form-control"');?>
<span class="text-danger"><?php echo form_error('payment_for'); ?></span>
...
<td><?php echo date("d-m-Y",strtotime($student['fcdate'])); ?></td>
...
?>
<tr><td colspan="6"></td><td align="right"><?php echo number_format($allreceive)?></td></tr>
</tbody>
