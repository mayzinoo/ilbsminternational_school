...
<h1>
<i class="fa fa-money"></i> <?php echo $this->lang->line('fees_collection'); ?> ( <?php echo date("d-m-Y",strtotime($sel_day));?> )  <div class="box-tools pull-right">
                        <small class="pull-right"><?=anchor("accountant/Studentfee/studentfeesDailyreportSearchPrint","<i class='fa fa-print'></i> Print","class='btn btn-primary btn-sm' target='_blank'")?></small> 
</div></h1> 
</section>
<!-- Main content -->
...
<div class="row">
<form role="form" action="<?php echo site_url('accountant/Studentfee/studentfeesDailyreportSearch') ?>" method="post" class="">
...
$('#from-date,#to-date,.date').datepicker({
format: date_format,
autoclose: true
});
