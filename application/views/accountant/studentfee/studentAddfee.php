...
<div class="row">
<!-- left column -->
<form action="<?php echo site_url("accountant/studentfee/create/" . $id) ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8">
...
<a href="<?php echo base_url() ?>accountant/studentfee" type="button" class="btn btn-primary btn-xs">
...
<?php echo form_dropdown("payment_for",$monthlist,"");?>
</span>
</div>
...
<?php echo form_dropdown("feegroup[]",$feegroups,'','class="form-control" onchange="getdata(\'fee_groups\',event)"'); ?>
...
?>">
<input class="form-control" name="amount[]" placeholder="" rows="3" value="<?php echo set_value('amount'); ?>">
...
?>">
<input class="form-control total" name="receive[]" placeholder="" rows="3" placeholder="Enter ..."><?php echo set_value('receive'); ?></input>
...
<td>   
<input type="text" name="alltotal" id="nettotal" value="0" class="form-control" readonly>
</td>
</tr>
</table>
