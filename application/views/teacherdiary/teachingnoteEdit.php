        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    ...
                    <form id="form1" action="<?php echo site_url('teacherdiary/teachingnote/edit/' . $id) ?>"  id="teachingnote" name="teachingnote" method="post" enctype="multipart/form-data" accept-charset="utf-8">
                        <div class="box-body">
