        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    ...
                    <form id="form1" action="<?php echo base_url() ?>teacherdiary/teacherdiary/create"  id="teacherdiary" name="teacherdiary" method="post" enctype="multipart/form-data" accept-charset="utf-8">
                        <div class="box-body">
