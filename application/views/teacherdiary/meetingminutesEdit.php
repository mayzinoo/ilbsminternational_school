            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title"><?php //echo $title;     ?>Edit Meeting Minutes</h3>
                    </div><!-- /.box-header -->
                    <form id="form1" action="<?php echo base_url() ?>teacherdiary/Meetingminutes/edit/<?=$row->id?>"  name="meetingminutes" method="post" enctype="multipart/form-data" accept-charset="utf-8">
                        <div class="box-body">
                           ...
                           <div class="row">
                            ...
                            ?>">
                                ...
                                <input id="opening_time" name="opening_time" placeholder="" type="text" class="form-control"  value="<?php echo $row->opening_time; ?>"  />
                            ...
                            ?>">
                                ...
                                <input id="closing_time" name="closing_time" placeholder="" type="text" class="form-control"  value="<?php echo $row->closing_time; ?>"  />
                            ...
                            ?>">
                                ...
                                <input id="place" name="place" placeholder="" type="text" class="form-control"  value="<?php echo $row->place; ?>"  />
                            ...
                            <div class="col-md-3">
                                ...
                                ?>">
                                    ...
                                    <input id="prepared_by" name="prepared_by" placeholder="" type="text" class="form-control"  value="<?php echo $row->prepared_by; ?>"  />
                                </div>
                            </div>
                            ...
                            <div class="col-md-3">
                                ...
                                ?>">
                                    ...
                                    <input id="approved_by" name="approved_by" placeholder="" type="text" class="form-control"  value="<?php echo $row->approved_by; ?>"  />
                                </div>
                            </div>
                            ...
                            ?>">
                               ...
                               <?php echo form_dropdown("teacher[]",$teacherlists,$list->teacher_id,'class="form-control"'); ?>
                                  ...
                                  <!--      <input name="sign[]" value="<?=$list->sign?>" placeholder="" type="text" class="filestyle form-control" />-->
                                  ...
                                  <td width="10%">
                                    <div class="form-group">
                                        <input name="sign[]" value="<?=$list->sign?>" type="text" class="form-control" />
                                        <?php echo form_error('sign[]'); ?></span>
                                        <div id="photo"> </div>
                                    </div>
                                  </td>
