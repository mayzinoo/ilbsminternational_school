...
<h1>
<i class="fa fa-mortar-board"></i> Course Outline Detail <small><?php echo $this->lang->line('student_fees1'); ?></small>
</h1>
</section>
<!-- Main content -->
   ...
   <div class="col-md-12">
                ...
                <div class="box box-primary">
                    <div class="box-header ptbnull">
                        <h3 class="box-title titlefix">Course Outline</h3>
                        <div class="box-tools pull-right">
                        </div><!-- /.box-tools -->
                    </div><!-- /.box-header -->
                    <div class="box-body">
                        <div class="table-responsive mailbox-messages">
                            <div class="download_label">Course Outline</div>
                            <table class="table table-striped table-bordered table-hover example">
                                 ...
                                 <tr>
                                 	<td colspan="3"><h3>ဘာသာရပ္ဆိုင္ရာ သင္ရိုးညြန္းတမ္း</h3></td>
                                 </tr>
                                    <tr>
                                        <th>Subjects
                                        </th>
                                        ...
                                        <tr>
                                          <td class="mailbox-name">
                                            ...
                                            <td class="mailbox-name">
                                             ...
                                             <td class="mailbox-name">
                                                <?php echo $monthlist[$expense->month]; ?>
                                            </td>
