        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    ...
                    <form id="form1" action="<?php echo base_url() ?>teacherdiary/dailyrecord/create"  id="dailyrecord" name="dailyrecord" method="post" enctype="multipart/form-data" accept-charset="utf-8">
                        <div class="box-body">
                           ...
                           <div class="row">
                            ...
                            ?>">
                               ...
                               <?php echo form_dropdown("subject[]",$subjectlists,'','class="form-control"'); ?>
                                  ...
                                  <td><input type="number" name="times[]" maxlength="1"/></td>
