...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            <i class="fa fa-credit-card"></i> Weekly Preparation <small></small>        </h1>
    </section>
            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title"><?php //echo $title;     ?>Add New Weekly Preparation</h3>
                    </div><!-- /.box-header -->
                    <form id="form1" action="<?php echo base_url() ?>teacherdiary/weeklypreparation/create"  id="weeklypreparation" name="weeklypreparation" method="post" enctype="multipart/form-data" accept-charset="utf-8">
                        <div class="box-body">
                           ...
                           <div class="row">
                            ...
                            ?>">
                                ...
                                <input id="date_from" name="date_from" placeholder="" type="text" class="form-control"  value="<?php echo set_value('date_from'); ?>"  />
                            ...
                            ?>">
                                ...
                                <input id="date_to" name="date_to" placeholder="" type="text" class="form-control"  value="<?php echo set_value('date_to'); ?>"  />
                            ...
                            ?>">
                               ...
                               <?php echo form_dropdown("school",$schools,'','class="form-control"'); ?>
                            ...
                            ?>">
                               ...
                               <?php echo form_dropdown("grade[]",$classlists,"",'class="form-control"'); ?>
