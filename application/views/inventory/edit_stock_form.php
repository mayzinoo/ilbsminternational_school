            ...
            <div class="col-md-12">             
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title">Edit Stock Form</h3>
                    </div> 
                    <form action="<?php echo site_url('Inventory/update_stock') ?>"  name="employeeform" method="post" accept-charset="utf-8"  enctype="multipart/form-data">
                        ...
                        <div class="box-body">
                           ...
                           <div class="form-group col-md-6">
                                ...
                                <?=form_input("item_name",$row->name,"class='form-control'")?>
                           ...
                           <div class="form-group col-md-6">
                                ...
                                <?=form_input("quantity",$row->quantity,"class='form-control'")?>
