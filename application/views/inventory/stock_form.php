            ...
            <div class="col-md-12">           
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title">Add New Stock Form</h3>
                    </div> 
                    <form id="form1" action="<?php echo site_url('Inventory/create_stock') ?>" name="employeeform" method="post" accept-charset="utf-8"  enctype="multipart/form-data">
                        <div class="box-body">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <?=form_input("item_name","","class='form-control'")?>
                           ...
                           <div class="form-group col-md-6">
                                ...
                                <?=form_input("quantity","","class='form-control'")?>
