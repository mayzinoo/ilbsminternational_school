                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        ...
                        <div class="box-tools pull-right">
                            <a href="<?php echo base_url(); ?>Inventory/insert_data/purchase_form" class="btn btn-primary btn-sm"  data-toggle="tooltip" title="Purchase Form" >
                        ...
                        <div class="box-body">
                            ...
                            <div class="row">
                                ...
                                <form id="purchaseperson">
                                    <div class="col-md-3">
                                    <div class="form-group">
                                    <label for="exampleInputEmail1">Purchase Person (or) Purchase Title</label>
                                    <input type="text" name="purchase_person" onkeyup="searchdata('purchaseperson')" class="form-control">
                                    <span class="text-danger"><?php echo form_error('purchase_person'); ?></span>
                                    </div>
                                    </div>
                                    ...
                                    <br/>
                                    <button type="button" name="search" onclick="searchdata('purchaseperson')" value="search" class="btn btn-primary"><i class="fa fa-search"></i> <?php echo $this->lang->line('search'); ?></button>
                                    </div>
                                    </div> 
                                ...
                                <form id="purchase">
                                    ...
                                    <span class="text-danger" required><?php echo form_error('start_date'); ?></span>
                                    </div>
                                    </div>
                                    ...
                                    <label for="exampleInputEmail1"></label>
                                    <br/>
                                    <button type="button" name="search" onclick="searchdata('purchase')"  value="search" class="btn btn-primary"><i class="fa fa-search"></i> <?php echo $this->lang->line('search'); ?></button>
                                    </div>
                                    </div> 
                                    <div class="col-md-1"></div>
                                </form>
                        ...
                        <div class="box-header with-border">
                            <h3 class="box-title"><i class="fa fa-users"></i> <?php echo $this->lang->line('Leave'); ?> Purchase <?php echo $this->lang->line('list'); ?> </h3>
                            <div class="box-tools pull-right">
                            </div>
                        </div>
                        <div class="box-body">
