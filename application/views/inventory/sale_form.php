...
<h3 class="box-title"><?php //echo $title;     ?>Add New Sale Form</h3>
</div><!-- /.box-header -->
<form id="form1" action="<?php echo base_url() ?>Inventory/create_sale"  id="sale" name="sale" method="post" enctype="multipart/form-data" accept-charset="utf-8">
<div class="box-body">
...
<div class="row">
        ...
        ?>">
           ...
           <?php echo form_input("sale_person","",'class="form-control"'); ?>
