...
<form id="form1" action="<?php echo base_url() ?>Inventory/update_sale"  id="sale" name="sale" method="post" enctype="multipart/form-data" accept-charset="utf-8">
<div class="box-body">
...
<div class="row">
        ...
        ?>">
            <label for="exampleInputEmail1">Sale Person</label>
        
           <?php echo form_input("sale_person",$row->sale_person,'class="form-control"'); ?>
        ...
        ?>">
          ...
          <?php echo form_input("customer",$row->customer_name,'class="form-control"'); ?>
  ...
  <tbody id="SourceWrapper">
    <?php $no=1; foreach($salelist->result() as $list){ ?> 
  <tr class="clonethis">
  <td class="no"><?=$no?></td>
      <td>
            <div class="form-group <?php
...
?>">
   ...
   <?php echo form_dropdown("item_name[]",$itemlist,$list->item_id,'class="form-control" onclick="clonesalerow()"'); ?>
...
?>">
   ...
   <?php echo form_input("total[]",$list->total,'class="form-control"'); ?>
...
?>">
   ...
   <?php echo form_input("quantity[]",0,'class="form-control" onkeyup="calculateTotal(this.value,event)"'); ?>
...
?>">
   ...
   <?php echo form_input("total[]",0,'class="form-control"'); ?>
