...
<h3 class="box-title"><?php //echo $title;     ?>Add New Purchase Form</h3>
</div><!-- /.box-header -->
<form id="form1" action="<?php echo base_url() ?>Inventory/create_purchase"  id="purchase" name="purchase" method="post" enctype="multipart/form-data" accept-charset="utf-8">
<div class="box-body">
...
<div class="row">
        ...
        <div class="col-md-2">
             <div class="form-group <?php
        if (form_error('purchase_person')) {
            echo 'has-error';
        }
        ?>">
            <label for="exampleInputEmail1">Purchase Person</label>
        
           <?php echo form_input("purchase_person","",'class="form-control"'); ?>
...
?>">
   ...
   <?php echo form_input("price[]",0,'class="form-control" '); ?>
