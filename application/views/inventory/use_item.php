                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        ...
                        <div class="box-tools pull-right">
                            <a href="<?php echo base_url(); ?>Inventory/insert_data/use_item_form" class="btn btn-primary btn-sm"  data-toggle="tooltip" title="Expense Form" >
                    ...
                    <div class="box-body">
                            ...
                            <div class="row">
                                ...
                                <form id="descript">
                                    ...
                                    <label for="exampleInputEmail1">Item Name (or) Description</label>
                                    <input type="text" name="description" onkeyup="searchdata('descript')" class="form-control">
                                    ...
                                    <br/>
                                    <button type="button" name="search" onclick="searchdata('descript')" value="search" class="btn btn-primary"><i class="fa fa-search"></i> <?php echo $this->lang->line('search'); ?></button>
                                    </div>
                                    </div> 
                                ...
                                <form id="use_item">
                                    ...
                                    <label for="exampleInputEmail1"></label>
                                    <br/>
                                    <button type="button" name="search" onclick="searchdata('use_item')"  value="search" class="btn btn-primary"><i class="fa fa-search"></i> <?php echo $this->lang->line('search'); ?></button>
                                    </div>
                                    </div> 
                                    <div class="col-md-1"></div>
                                </form>
                        ...
                        <div class="box-header with-border">
                            <h3 class="box-title"><i class="fa fa-users"></i> <?php echo $this->lang->line('Leave'); ?> Expense <?php echo $this->lang->line('list'); ?>s </h3>
                            <div class="box-tools pull-right">
                            </div>
                        </div>
                        <div class="box-body">
