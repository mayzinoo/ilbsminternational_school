                   ...
                   <li class="<?php echo set_Submenu('admin/feegroup'); ?>"><a href="<?php echo base_url(); ?>accountant/feegroup"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('fees_group'); ?></a></li>
                        ...
                        <li class="treeview <?php echo set_Topmenu('Reports'); ?>">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li class="<?php echo set_Submenu('reportbyname/index'); ?>"><a href="<?php echo base_url(); ?>accountant/studentfee/studentfeesreport"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('fees_statement'); ?></a></li>
