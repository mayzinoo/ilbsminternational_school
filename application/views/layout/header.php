...
<html <?php echo $this->customlib->getRTL(); ?>>
   ...
   /* $contact_message=$this->db->query("SELECT * FROM message_from_website WHERE status=0");
    ...
    $birthday=$this->db->query("Select * from students where MONTH(dob)=MONTH(CURDATE()) 
        	AND DAY(dob) BETWEEN DAY(CURDATE()) AND DAY(CURDATE())+7 ORDER BY DAY(dob) ASC");
        ...
        <div class="wrapper">
            <header class="main-header" id="alert">            
                <a href="<?php echo base_url(); ?>admin/admin/dashboard" class="logo">                 
                    ...
                    <span class="logo-lg"><img src="<?php echo base_url(); ?>uploads/school_content/logo/<?=$cur_session->image?>" alt="<?php echo $this->customlib->getAppName() ?>"/></span>
                </a>             
                        ...
                        <div class="pull-right">    
                            ...
                            <div class="navbar-custom-menu">
                                ...
                                <ul class="nav navbar-nav"> 
                                   ...
                                   <li class="dropdown">
                                        <a class="dropdown-toggle" data-toggle="dropdown" href="#" aria-expanded="false"> <i class="fa fa-birthday-cake"></i>  <i class="badge"><?=$birthday->num_rows()?></i>
                                             <i class="fa fa-caret-down"></i>
                                        </a>
                                         <ol class="dropdown-menu dropdown-user">
                                         <?php foreach($birthday->result() as $cm): ?>    
                                          <li><a href="#">
                                              <i class="fa fa-comment"></i> <?=$cm->firstname." ".$cm->lastname?> (<?=$cm->dob?>) </a>
                                            </li>
                                        <?php endforeach; ?>
                                        </ol>                              
                                    </li>  
                                    
                                     <li><a href="http://www.essentialschool.online/help.php" target="_blank">
                                              <i class="fa fa-info-circle"></i> Help </a>
                                    </li>
                                    
                                    <li class="<?php echo set_Submenu('admin/student/userpass'); ?>">
                                        <a href="<?php echo base_url(); ?>student/userpass" target="_blank">
                                        <i class="fa fa-key"></i> Parent's Logins</a></li>
                                ...
                                <li class="dropdown">
                                     ...
                                     <li class="dropdown">
                                        <a class="dropdown-toggle" data-toggle="dropdown" href="#" aria-expanded="false"> <i class="fa fa-bell fa-fw"></i> Enrole <i class="badge"><?=$totaler?></i>
                                              <i class="fa fa-caret-down"></i>
                                        </a>
    ...
    <section class="sidebar" id="sibe-box">
        ...
        <ul class="sidebar-menu verttop">
          ...
          <li class="treeview <?php echo set_Topmenu('Attendance'); ?>">
                ...
                <ul class="treeview-menu">
                    <li class="<?php echo set_Submenu('stuattendence/classattendencereport'); ?>"><a href="<?php echo base_url(); ?>admin/stuattendence/classattendencereport"><i class="fa fa-angle-double-right"></i> Daily <?php echo $this->lang->line('student_attendance'); ?></a></li>
                                       <li class="<?php echo set_Submenu('stuattendence/index'); ?>"><a href="<?php echo base_url(); ?>admin/stuattendence/index/<?php echo $this->setting_model->getCurrentSessionid(); ?>"><i class="fa fa-angle-double-right"></i> Student Att Reports</a></li>
                    ...
                    <li class="<?php echo set_Submenu('teaattendence/index'); ?>"><a href="<?php echo base_url(); ?>admin/teaattendence"><i class="fa fa-angle-double-right"></i> Teacher Att Reports</a></li>
            ...
            <li class="treeview <?php echo set_Topmenu('Examinations'); ?>">
                ...
                <ul class="treeview-menu">
                 ...
                 <li class="<?php echo set_Submenu('admin/Inter_Reportcard/index'); ?>"><a href="<?php echo base_url(); ?>admin/Inter_mark/index"><i class="fa fa-angle-double-right"></i> Inter Exam Results </a></li>
            ...
            <li class="treeview <?php echo set_Topmenu('Improvement'); ?>">
                ...
                <ul class="treeview-menu">
                     <li class="<?php echo set_Submenu('Improvement_result/index'); ?>"><a href="<?php echo base_url(); ?>improvement/Improvement_result"><i class="fa fa-angle-double-right"></i>Preschool Results</a></li>
                      ...
                      <li class="<?php echo set_Submenu('Improvement_result/reportcard_month'); ?>"><a href="<?php echo base_url(); ?>improvement/Improvement_result/reportcard_month"><i class="fa fa-angle-double-right"></i>Improvement Months</a></li>
                </ul>
            ...
            <li class="treeview <?php echo "Info Center"; ?>">
                ...
                <ul class="treeview-menu">
                    ...
                    <li class="<?php echo set_Submenu('guest/guestlist'); ?>"><a href="<?php echo base_url(); ?>guest/guestlist"><i class="fa fa-angle-double-right"></i> Guest Lists</a></li>
                    <li class="<?php echo set_Submenu('student/barcodeprint'); ?>"><a href="<?php echo base_url(); ?>student/barcodeprint"><i class="fa fa-angle-double-right"></i> Barcode Print</a></li>
            ...
            <li class="treeview <?php echo set_Topmenu('Download Center'); ?>">
             ...
             <li class="treeview <?php echo set_Topmenu('Communicate'); ?>">
                ...
                <ul class="treeview-menu">
                    ...
                    <li class="<?php echo set_Submenu('mailsms/index'); ?>"><a href="<?php echo base_url(); ?>admin/mailsms/index"><i class="fa fa-angle-double-right"></i> Private Notice</a></li>
                </ul>
            </li>
