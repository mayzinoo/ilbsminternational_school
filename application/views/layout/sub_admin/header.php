...
<html <?php echo $this->customlib->getRTL(); ?>>
    ...
    <body class="hold-transition skin-blue fixed sidebar-mini">
        <div class="wrapper">
            ...
            <aside class="main-sidebar" id="alert2">                
                ...
                <ul class="treeview-menu">
                    <li class="<?php echo set_Submenu('studentfee/index'); ?>"><a href="<?php echo base_url(); ?>accountant/studentfee/index/0"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('collect_fees'); ?></a></li>
                     <li class="<?php echo set_Submenu('studentfee/studentfeesDailyReport'); ?>"><a href="<?php echo base_url(); ?>accountant/studentfee/studentfeesDailyReport"><i class="fa fa-angle-double-right"></i> Daily Report</a></li>

                      <li class="<?php echo set_Submenu('studentfee/studentfeesMonthlyReport'); ?>"><a href="<?php echo base_url(); ?>accountant/studentfee/studentfeesMonthlyReport"><i class="fa fa-angle-double-right"></i> Monthly Report</a></li>
                         <li class="<?php echo set_Submenu('studentfee/studentfeesYearlyReport'); ?>"><a href="<?php echo base_url(); ?>accountant/studentfee/studentfeesYearlyReport"><i class="fa fa-angle-double-right"></i> Yearly Report</a></li>
                   
                   <li class="<?php echo set_Submenu('admin/feegroup'); ?>"><a href="<?php echo base_url(); ?>accountant/feegroup"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('fees_group'); ?></a></li>
                </ul>
            </li>
            ...
            ?>
                ...
                <ul class="treeview-menu">
                    ...
                    <li class="<?php echo set_Submenu('stuattendence/stumaintenance'); ?>"><a href="<?php echo base_url(); ?>teacher/stuattendence/stumaintenance"><i class="fa fa-angle-double-right"></i> Attandence Maintenance</a></li>
 ...
 <li class="<?php echo set_Submenu('teaattendence/index'); ?>"><a href="<?php echo base_url(); ?>teacher/teaattendence"><i class="fa fa-angle-double-right"></i> Teacher Attendance</a></li>                </ul>
            </li>
