...
<h1>
<i class="fa fa-credit-card"></i> Improvement Results Form<small></small>        </h1>
</section>
...
<form id="form1" action="<?php echo base_url() ?>teacher/improvement/Improvement_result/search_student"  id="improvement" name="improvement" method="post" enctype="multipart/form-data" accept-charset="utf-8">
<div class="box-body">
...
<?php echo form_open("teacher/improvement/Improvement_result/create")?>
    <div class="col-md-2">
      <div class="form-group <?php
if (form_error('date')) {
    echo 'has-error';
...
?>">
   ...
   <?php echo form_dropdown("improvement_id",$lessons,$improvement_id,'class="form-control"'); ?>
