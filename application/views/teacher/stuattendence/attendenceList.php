...
<li class="active"><a href="<?php echo base_url(); ?>teacher/Stuattendence/" ><i class="fa fa-list"></i> Attendance Lists</a></li>

<li><a href="<?php echo base_url(); ?>teacher/Stuattendence/absent" ><i class="fa fa-newspaper-o"></i> Absent Lists</a></li>
<li><a href="<?php echo base_url(); ?>teacher/Stuattendence/leave" ><i class="fa fa-newspaper-o"></i> Leave Lists</a></li>
</ul>
    <div class="box box-primary">
...
<!-- <td><?php   echo $count; ?></td>
 -->
<td style=" word-break: break-all;width:20% !important"><?php echo $list->firstname . " " . $list->lastname; ?></td>
 <td><?=($list->one)?></td> 
                        <td><?=($list->two)?></td> 
                        <td><?=($list->three)?></td> 
                        <td><?=($list->four)?></td> 
