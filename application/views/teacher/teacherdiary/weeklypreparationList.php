            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    <div class="box-header ptbnull">
                        ...
                        <small class="pull-right"><?=anchor("teacher/teacherdiary/Weeklypreparation/createform","+ Add","class='btn btn-primary btn-sm'")?></small> 
                        </div><!-- /.box-tools -->
                    </div><!-- /.box-header -->
                    <div class="box-body">
                        <div class="table-responsive mailbox-messages">
                            ...
                            <div class="col-md-6">
                                <div class="row">
                                    <form role="form" action="<?php echo site_url('teacher/teacherdiary/Weeklypreparation/Search') ?>" method="post" class="">
