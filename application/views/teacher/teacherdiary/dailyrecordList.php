            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    <div class="box-header ptbnull">
                        ...
                        <small class="pull-right"><?=anchor("teacher/teacherdiary/Dailyrecord/createform","+ Add","class='btn btn-primary btn-sm'")?></small>   
                        </div><!-- /.box-tools -->
                    </div><!-- /.box-header -->
                    ...
                    <div class="box-body">
                    <div class="row">
<form role="form" action="<?php echo site_url('teacher/teacherdiary/Dailyrecord/dailyrecordSearch') ?>" method="post" class="">
