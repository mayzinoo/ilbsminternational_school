        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    ...
                    <form id="form1" action="<?php echo site_url('teacher/teacherdiary/Dailyrecord/edit/' . $id) ?>"  id="dailyrecord" name="dailyrecord" method="post" enctype="multipart/form-data" accept-charset="utf-8">
                        <div class="box-body">
...
<!--                                 <th>Teachers</th>
 -->                                  <th>Description</th>
                            ...
                            ?>">
                              ...
                              <td><input type="number" name="times" maxlength="1" value="<?=$list->times?>"/></td>
