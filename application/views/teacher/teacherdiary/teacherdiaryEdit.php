...
<div class="content-wrapper">
            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title"><?php //echo $title;     ?>Edit New Course Outlines</h3>
                    </div><!-- /.box-header -->
                    <form id="form1" action="<?php echo site_url('teacher/teacherdiary/teacherdiary/edit/' . $id) ?>"  id="teacherdiary" name="teacherdiary" method="post" enctype="multipart/form-data" accept-charset="utf-8">
                        <div class="box-body">
  ...
  <div class="form-group <?php
                            ...
                            ?>">
                               <?php echo form_dropdown("month[]",$monthlist,$list->month,'class="form-control"'); ?>
