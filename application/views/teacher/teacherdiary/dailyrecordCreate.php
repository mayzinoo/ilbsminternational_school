...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            <i class="fa fa-credit-card"></i> Daily Record <small></small>        </h1>
    </section>
            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title"><?php //echo $title;     ?>Add New Daily Record</h3>
                    </div><!-- /.box-header -->
                    <form id="form1" action="<?php echo base_url() ?>teacher/teacherdiary/dailyrecord/create"  id="dailyrecord" name="dailyrecord" method="post" enctype="multipart/form-data" accept-charset="utf-8">
                        <div class="box-body">
                           ...
                           <div class="row">
                            ...
                            ?>">
                               ...
                               <?php echo form_dropdown("subject[]",$subjectlists,'','class="form-control"'); ?>
                                  ...
                                  <td data-label="Times"><input type="number" name="times" maxlength="1"/></td>
