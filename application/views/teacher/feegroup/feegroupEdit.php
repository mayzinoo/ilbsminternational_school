        ...
        <div class="row">
            <div class="col-md-4">
                ...
                <div class="box box-primary">
                    ...
                    <form action="<?php echo site_url("teacher/feegroup/edit/" . $id) ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8">
                        <div class="box-body">
                            ...
                            <div class="form-group">
                             ...
                             <div class="form-group">
                                ...
                                <input autofocus="" id="amount" name="amount" placeholder="" type="text" class="form-control"  value="<?php echo set_value('amount', $feegroup['amount']); ?>" />
                                    ...
                                    foreach ($feegroupList as $feegroup) {
                                        ...
                                        <tr>
                                            ...
                                            <td class="mailbox-date pull-right">
                                                <a href="<?php echo base_url(); ?>teacher/feegroup/edit/<?php echo $feegroup['id'] ?>" class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('edit'); ?>">
                                                    <i class="fa fa-pencil"></i>
                                                </a>
                                                <a href="<?php echo base_url(); ?>teacher/feegroup/delete/<?php echo $feegroup['id'] ?>"class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="return confirm('Are you sure you want to delete this item?');">
