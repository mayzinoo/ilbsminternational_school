...
<?=anchor("teacher/Reportcard/rpcardsfront/".$student["id"],"&laquo; Front Report","class='btn active pull-right'");?>
<?=anchor("teacher/Reportcard/rpcardsbackwithgrades/".$student["id"],"&laquo; Grades","class='btn active'");?>
