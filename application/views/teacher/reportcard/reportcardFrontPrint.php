...
<?=anchor("teacher/Reportcard/rpcardsback/".$student["id"],"&laquo; Back Report","class='btn active'");?>

<?=anchor("teacher/Reportcard/printwithgrade/".$student["id"],"&laquo; Grades","class='btn active'");?>
...
<div class="row header">
                         ...
                         <img src="<?php echo base_url(); ?>uploads/school_content/logo/<?php echo $settinglist->left_logo; ?>" width="110%">                                 
                            ...
                            <div class="col-sm-6  lower">
                                <strong class="title">INTERNATIONAL LANGUAGE & BUSINESS SCHOOL OF MONYWA</strong>


                                <strong ><?php echo $settinglist->address; ?> </strong>

                               <?php //echo $settinglist->title2; ?> <?php //echo $settinglist->level?> <!-- ဆင့္  -->
                              <?php echo $settinglist->title; ?>

                            </div><!--/col-->
                            <div class="col-sm-1 allowno">
                            <div><small>  ပညာေရး၀န္ၾကီးဌာန၏ <br />
...
ခြင့္ျပဳမိန္႕အမွတ္</div>
                    ...
                    <center><img src="<?php echo base_url(); ?>/backend/images/<?php echo $settinglist->right_logo; ?>" style="display:block;text-align:center" align="center"></center>
                               ...
                               <div class="col-sm-1 lower">
                    <center><img src="<?php echo base_url(); ?>/backend/images/<?php echo $settinglist->iso; ?>" style="display:block;text-align:center" align="center"></center>
...
foreach($rpcards->result() as $r):
 ?>
<td align="center"><?php    echo $r->get_marks?></td>
...
for($a=$no;$a<count($titlearr)-1;$a++)
{
	if($a==7)
	{
		if($totalmark==0){$totalmark="";}else{$totalmark=$totalmark;}
	echo "<td align='center'>".$totalmark."</td>";
	}
