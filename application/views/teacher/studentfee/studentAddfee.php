...
<div class="row">
<!-- left column -->
<form action="<?php echo site_url("teacher/studentfee/create/" . $id) ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8">
...
<?php echo form_dropdown("payment_method",$paymenttype,"");?>
