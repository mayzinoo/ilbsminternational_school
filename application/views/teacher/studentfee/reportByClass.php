                        ...
                        foreach ($student_fees_array as $key => $student_array) {
                            ...
                            <section class="invoice" style="margin: 10px 15px;">                              
                                ...
                                <div class="row no-print">
                                    <div class="col-xs-12">
                                        <a href="<?php echo base_url(); ?>teacher/studentfee/addfee/<?php echo $st_detail['id']; ?>" class="btn btn-primary pull-right"><i class="fa fa-credit-card"></i> <?php echo $this->lang->line('collect_fees'); ?></button>
