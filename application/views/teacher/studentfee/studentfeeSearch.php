...
<div class="row">
<form role="form" action="<?php echo site_url('teacher/studentfee/search') ?>" method="post" class="">
...
<li class="<?=($this->uri->segment(4)==0 ? 'active' : '')?>"><a href="<?php echo base_url(); ?>studentfee/index/0" ><i class="fa fa-list"></i> No Paid Lists</a></li>
<li class="<?=($this->uri->segment(4)==1 ? 'active' : '')?>"><a href="<?php echo base_url(); ?>studentfee/index/1" ><i class="fa fa-newspaper-o"></i> Paid Lists</a></li>
</ul>
...
<td><?php echo $student['fcdate']; ?></td>
<td class="pull-right">
<?php 
if($student['status']==1)
{
?>
<a  title="View Details" href="<?php echo base_url(); ?>teacher/studentfee/view/<?php echo $student['id']?>/<?php echo $student['student_id']?>" class="btn btn-info btn-xs" data-toggle="tooltip" title="" data-original-title="">
<i class="fa fa-list"></i>
</a>
<a title="Print" target="_blank" href="<?php echo base_url(); ?>teacher/studentfee/printvoc/<?php echo $student['id']?>/<?php echo $student['student_id']?>" class="btn btn-info btn-xs" data-toggle="tooltip" title="" data-original-title="">
<i class="fa fa-print"></i>
</a>
 <a href="<?php echo base_url(); ?>teacher/studentfee/edit/<?php echo $student['id']?>/<?php echo $student['student_id']?>" class="btn btn-info btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('edit'); ?>">
<i class="fa fa-pencil"></i>
</a>
<a href="<?php echo base_url(); ?>teacher/studentfee/delete/<?php echo $student['id']?>"class="btn btn-info btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="return confirm('Are you sure you want to delete this item?')";>
...
?>
<tr><td colspan="6"></td><td align="right"><?php echo number_format($allamount)?></td><td align="right"><?php echo number_format($allreceive)?></td></tr>
</tbody>
