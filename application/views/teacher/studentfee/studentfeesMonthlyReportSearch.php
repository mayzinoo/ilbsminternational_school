...
<i class="fa fa-money"></i> <?php echo $this->lang->line('fees_collection'); ?> ( <?php echo strtoupper($month_sel);?> )  <div class="box-tools pull-right">
                        <small class="pull-right"><?=anchor("teacher/Studentfee/studentfeesMonthlyreportSearchPrint","<i class='fa fa-print'></i> Print","class='btn btn-primary btn-sm' target='_blank'")?></small> 
</div></h1> 
</section>
<!-- Main content -->
...
<div class="row">
<form role="form" action="<?php echo site_url('teacher/studentfee/studentfeesMonthlyreportSearch') ?>" method="post" class="">
