                                ...
                                <tbody>
                                    ...
                                    if (empty($feeList)) {
                                        ...
                                        <tr>
                                            ...
                                            <td class="text text-right">
                                                <a href="<?php echo base_url() ?>teacher/studentfee/addfee/<?php echo $feeList->student_id ?>" class="btn btn-primary btn-xs" data-toggle="tooltip" title="<?php echo $this->lang->line('view'); ?>" data-original-title="<?php echo $this->lang->line('view'); ?>">
