        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <form action="<?php echo site_url('teacher/timetable/create') ?>" method="post" accept-charset="utf-8">
                        <div class="box-body">
                    ...
                    <div class="box box-warning">
                        ...
                        <div class="box-body">
                                ...
                                <form role="form" id=""  class="addmarks-form"  method="post" action="<?php echo site_url('teacher/timetable/insert_timetable') ?>">
                                    <?php echo $this->customlib->getCSRF(); ?>
