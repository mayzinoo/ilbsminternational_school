...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            <i class="fa fa-credit-card"></i> Parents' Feedbacks </h1>
    </section>
                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        <div class="row">
                            ...
                            <div class="col-md-5">
                                <div class="row">
                                    <form role="form" action="<?php echo site_url('admin/feedback/feedbackSearch') ?>" method="post" class="">
                                        <?php echo $this->customlib->getCSRF(); ?>    
                                        <div class="col-sm-6">
                                            <div class="form-group">
                    ...
                    <div class="box box-info">
                        <div class="table-responsive mailbox-messages">
                            <div class="download_label">Feedback Lists</div>
                            <table class="table table-hover table-striped table-bordered example">
                               ...
                               <tbody>
                                    ...
                                    if (empty($feedbacklist)) {
                                        ...
                                        <td class="mailbox-name">
                                                ...
                                                <td class="mailbox-date pull-right">
                                                    ...
                                                    <a href="<?php echo base_url(); ?>admin/feedback/edit/<?php echo $fb['id'] ?>" class="btn btn-default btn-xs"  data-toggle="tooltip" title="Reply">
                                    ...
                                    <tr><td colspan="4"></td><td><?=number_format($total)." ".$fb["currency"]?></td></tr>
