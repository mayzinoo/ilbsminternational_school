...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            <i class="fa fa-credit-card"></i> Monthly Salary <small class="pull-right"><?=anchor("admin/Salary/createform","Add New")?></small></h1>
    </section>
        ...
        <div class="row">
            <div class="col-md-4">
                ...
                <div class="box box-primary">
                    ...
                    <form action="<?php echo site_url("admin/salary/edit/" . $id) ?>"  id="salary" name="salary" method="post" accept-charset="utf-8"  enctype="multipart/form-data">
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="hidden" name="teacher_name" value='<?=$salary["name"]?>' >
                                <?=form_dropdown("teacher_id",$teachers,$salary["teacher_id"],"class='form-control' onchange=getposition(this.value)")?>
                                <span class="text-danger"><?php echo form_error('name'); ?></span>
                            </div>
                          <div class="form-group">
                                <label for="exampleInputEmail1">Position</label>
                                <input id="position" name="position" placeholder="" type="text" class="form-control"  value="<?php echo $salary['position']; ?>" />
                            ...
                            <div class="form-group">
                              ...
                              <div style="float:left">  <input id="currency" name="currency" placeholder="" class="form-control" type="text"  value="<?php echo set_value('currency', $salary['currency']); ?>" size="5" readonly/>
