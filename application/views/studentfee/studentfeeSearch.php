...
<div class="row">
<form role="form" action="<?php echo site_url('studentfee/search/'.$this->uri->segment(3))?>" method="post" class="">
...
<li class="<?=($this->uri->segment(3)==0 ? 'active' : '')?>"><a href="<?php echo base_url(); ?>studentfee/index/0" ><i class="fa fa-list"></i> No Paid Lists</a></li>
<li class="<?=($this->uri->segment(3)==1 ? 'active' : '')?>"><a href="<?php echo base_url(); ?>studentfee/index/1" ><i class="fa fa-newspaper-o"></i> Paid Lists</a></li>
</ul>
