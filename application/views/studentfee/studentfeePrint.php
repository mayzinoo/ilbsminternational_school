                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4 text-right">
                                ...
                                <address>
                                    ...
                                    echo date("d-m-Y, h:i:s A",strtotime($show->paydate))?></strong><br/>
Payment For : <?php echo substr($show->payment_for,0,-1); ?>
                                </address>                               
                            </div>
                        </div>      
...
<b><?php echo number_format($show->total_received)?></b>
 ...
 <br/>
    ...
    <br/>
<div class="row">
<div class="col-sm-8"> <strong> No Refund, No Transfer</strong></div>
