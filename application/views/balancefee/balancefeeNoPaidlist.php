...
<form role="form" action="<?php echo site_url('balance_fee/noPaidsearch/')?>" method="post" class="">
...
<li class="active"><a><i class="fa fa-list"></i> No Paid Lists</a></li>
...
<a  href="<?php echo base_url(); ?>balance_fee/addfee/<?php echo $student['student_id'] ?>/<?php echo $student['id']?>" class="btn btn-info btn-xs" data-toggle="tooltip" title="" data-original-title="">
<?php
