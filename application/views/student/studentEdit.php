                                ...
                                <div class="around10">
                                    ...
                                    <div class="row">
                                        <div class="col-md-2">
                                         ...
                                         <div class="col-md-1">
                                            <div class="form-group">
                                                ...
                                                <input id="finger_id" name="finger_id" placeholder="" type="text" class="form-control"  value="<?php echo set_value('finger_id', $student['finger_id']); ?>"/>
                                        ...
                                        <div class="col-md-1">
                                            <div class="form-group">
                                                ...
                                                <input id="machine_id" name="machine_id" placeholder="" type="text" class="form-control"  value="<?php echo set_value('machine_id', $student['machine_id']); ?>" />
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <input id="rfid" name="rfid" placeholder="" type="text" class="form-control"  value="<?php echo set_value('rfid', $student['rfid']); ?>" />
                                        ...
                                        <div class="col-md-2">
                                          ...
                                          <div class="col-md-2">
                                            ...
                                            <div class="form-group">
                                             ...
                                             <?php echo form_dropdown("inter_class",$inter_class,set_value("inter_class",$student['inter_class']),"class='form-control'");?>
                                    ...
                                    <div class="row">
                                        <div class="col-md-2">
                                         ...
                                         <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <?=form_dropdown("session_id",$sessionlist,set_value('session_id',$student["sess_id"]),"class='form-control'")?>
                                       ...
                                       <div class="col-md-2">
                                            ...
                                            <?php echo form_dropdown("resign",array(0=>"No",1=>"Yes"),$student["resign"],"class='form-control'");?>
                                           ...
                                           <div class="col-md-2">
                                            ...
                                            <?php echo form_dropdown("school",$school,$student["school"],"class='form-control'");?>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                         ...
                                         <div class="col-md-3">
                                              <div class="form-group">
                                                <label for="exampleInputFile"><?php echo $this->lang->line('select_image'); ?></label>
                                                <div><input class="filestyle form-control" type='file' name='guardian_file' id="guardian_file" size='20' />
                                                </div>
                                                <span class="text-danger"><?php echo form_error('guardian_file'); ?></span></div>
