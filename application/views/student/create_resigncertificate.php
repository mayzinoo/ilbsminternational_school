        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="around10 padding_md">
                    <?=form_open_multipart('Student/create_resigncertificate/')?>
                    <div class="row">
                        <div class="col-md-2">
                            <div class="form-group">
                                <label>Enter Date</label>
                                <input type="text" name="enter_date" class="form-control" id="admission_date">
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input list="browsers" type="text" name="student_name" class="form-control" onclick=adminsionnosearch(this.value)>
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <select name="school_no" class="form-control" id="searchresult">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="resign_date" class="form-control" id="admission_date">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="yearfrom" class="form-control"  id="admission_date">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                <label>Year (To)</label>
                                <input type="text" name="yearto" class="form-control"  id="admission_date">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="moved_school" class="form-control">
                            </div>
                        </div>
                     </div><!--end second row-->
                     <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="moved_division" class="form-control">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                <label>Moved Township</label>
                                <input type="text" name="moved_township" class="form-control">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                <label>Moved City</label>
                                <input type="text" name="moved_city" class="form-control">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                <label>Attendance Class</label>
                                <input type="text" name="letattend_class" class="form-control">
                            </div>
                        </div>
                     </div><!--end third row-->
                     <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="letattend_date" class="form-control" id="admission_date">
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="form-group">
                                <label>Date of Birth</label>
                                <input type="text" name="dob" class="form-control" id="admission_date">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                <label>Now Attendance Class</label>
                                <input type="text" name="nowattend_class" class="form-control">
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="form-group">
                                <label>Attended Date </label>
                                <input type="text" name="attend_date" class="form-control" id="admission_date">
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="form-group">
                                <label>Roll Call Time </label>
                                <input type="text" name="rollcalltime" class="form-control">
                            </div>
                        </div>
                     </div><!--end forth row-->
                     <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label>Sign</label>
                                <input type="text" name="parent_sign" class="form-control">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label>NRC No</label>
                                <input type="text" name="parent_nrc" class="form-control">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                <label>Date</label>
                                <input type="text" name="parent_date" class="form-control" id="admission_date">
                            </div>
                        </div>
                     </div><!--end fifth row-->
                     <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label>School</label>
                                <input type="text" name="principal_school" class="form-control">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
