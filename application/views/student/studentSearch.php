                                        ...
                                        if (empty($resultlist)) {
                                            ...
                                            foreach ($resultlist as $student) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php echo $student['inter_class']; ?></td>
                                                    ...
                                                    <td><img src="<?php echo base_url().$student['image']; ?>" width="80"/></td>


                                                    <td class="pull-right">
<button data-toggle="modal" data-target="#sendmessage" data-whatever="<?=$student['firstname'].$student['lastname']?>" class="btn btn-default btn-xs" title="Send Message">
...
<div class="modal fade" id="sendmessage" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <?=form_open("student/send_message")?>
      <div class="modal-body">
          <div class="form-group">
            <label for="recipient-name" class="col-form-label">Recipient:</label>
            <input type="text" class="form-control" class="recipient-name">
          </div>
          <div class="form-group">
