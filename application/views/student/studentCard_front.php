...
<body>
    ...
    <?=anchor("Student/cardprint_back/".$student["id"],"&laquo; Back","class='btn active'");?>
...
<div class="col-sm-6">
    ...
    <div class="top_card">
        ...
        <div class="col-sm-8">
            <div class="txt_card">
            <p><b><span style="">ကိုယ္ပိုင္ေက ်ာင္း</span></b><br/>
                အမွတ္(၁/၆)သာစည္လမ္း၊ ခ ်မ္းၿမသာစည္ရပ္၊မံုရြာၿမိဳ႕<br/>
...
barcode.php?f=svg&s=code39&d=<?=str_pad($student['id'],8,"0",STR_PAD_LEFT)?>&sy=0.4&&ms=r&md=0.8" class="barcode"/>
    ...
    <div class="col-sm-12 bottom_card">
        <div class="col-sm-6">
            <p style="margin-left:4px;">admin@ilbsm.com</p>
        </div>
        <div class="col-sm-6">
            <p style="float:right;margin-right:5px;">www.ilbsm.com</p>
        </div>
    </div><!--bottom-->
</div>
</div>
