            ...
            <div class="col-md-12">
                    ...
                    <div class="box box-warning">
                        ...
                        <div class="box-body">
                                ...
                                <form role="form" id=""  class="addmarks-form"  method="post" action="<?php echo site_url('admin/timetable/edit_timetable') ?>">
                                        ...
                                        <table class="table table-striped table-hover">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th colspan="2">
                                                        <?php echo form_dropdown("academic_year",$session_lists,$time->academic_year,"class='form-control'"); ?>
                                                    </th>
                                                </tr>
                                                <tr>
                                                    <th>
                                            ...
                                            <tbody>
                                                   ...
                                                   <?php
                                                    $i=1;
                                                        ...
                                                        <tr>
                                                            <?php 
                                                            if($list->sec1 =="" && $list->sec2 =="" && $list->sec3 =="" && $list->sec4 =="" && $list->sec5 =="" && $list->sec6 =="" && $list->sec7 =="" && $list->sec8 =="") 
                                                            { ?>
                                                            <th>
