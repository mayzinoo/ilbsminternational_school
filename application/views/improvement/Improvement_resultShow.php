...
?>
    <tr>
        ...
        <td class="mailbox-date">
            <a href="<?php echo base_url(); ?>improvement/Improvement_result/edit_show/<?php echo $row->subject_id?>/<?php echo $row->student_id?>" class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('edit'); ?>">
