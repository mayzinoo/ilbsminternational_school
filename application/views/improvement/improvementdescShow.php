...
<h1>
<i class="fa fa-mortar-board"></i> Improvement <small><?php echo $this->lang->line('student_fees1'); ?></small>
</h1>
</section>
<!-- Main content -->
...
<h3 class="box-title titlefix">Improvement</h3>
...
<div class="download_label"><?=$show->lessontitle?> <br/><br/><small><?=$show->rank?></small></div>
<table class="table table-striped table-bordered table-hover example">
<thead>

<tr>
<td colspan="3"><h3><?=$show->lessontitle?></h3><p><?=$show->rank?></p></td>
</tr>
<tr>
<th width="15">No</th>
<th>Description</th>                                      
