...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            <i class="fa fa-credit-card"></i> KG Results      </h1>
    </section>
            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    <div class="box-header ptbnull">
                        <h3 class="box-title titlefix">KG Results</h3>
                        <div class="box-tools pull-right">
                        <small class="pull-right"><?=anchor("improvement/Improvement_result/kgresult_createform","+ Add","class='btn btn-primary btn-sm'")?></small>   
                        </div><!-- /.box-tools -->
                    </div><!-- /.box-header -->
                    <div class="box-body">
                        <div class="table-responsive mailbox-messages">
                            <div class="download_label">KG Improvement Results</div>
                                ...
                                <tbody>
                                    ...
                                    foreach ($resultlist->result() as $expense) {
                                        ...
                                        <tr>
                                            ...
                                            <td class="mailbox-name">
                                                <?php echo $expense->cls?> (<?php echo $expense->section?>)
