...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            <i class="fa fa-credit-card"></i> Improvement Results      </h1>
    </section>
                                    ...
                                    foreach ($resultlist->result() as $expense) {
                                        ...
                                        <tr>
                                           ...
                                           <td class="mailbox-date pull-right">
                                                <a href="<?php echo base_url(); ?>improvement/Improvement_result/view/<?php echo $expense->id?>" class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('show'); ?>" >
