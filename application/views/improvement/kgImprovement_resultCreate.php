...
<h1>
<i class="fa fa-credit-card"></i>KG Improvement Results Form<small></small>        </h1>
</section>
...
<form id="form1" action="<?php echo base_url() ?>improvement/Improvement_result/search_kgstudent"  id="improvement" name="improvement" method="post" enctype="multipart/form-data" accept-charset="utf-8">
<div class="box-body">
...
<div class="box-header with-border">
<h3 class="box-title"><?php //echo $title;     ?>Add New KG Improvement Results</h3>
</div><!-- /.box-header -->
<div class="row box-body">
<div class="box-info with-border">
<?php echo form_open("improvement/Improvement_result/kgresult_create")?>
    <div class="col-md-2">
      <div class="form-group <?php
if (form_error('date')) {
    echo 'has-error';
...
?>">
   ...
   <?php echo form_dropdown("improvement_id",$lessons,$improvement_id,"class='form-control' onclick=kgimprosearch(this.value)"); ?>
 ...
 <div class="col-md-3">
   ...
   <select name="kgdesc" class="form-control" id="descsearchresult">
...
<script type="text/javascript">
    function kgimprosearch(improid)
    {
        
        data="improid="+improid;
        // alert(data);
        $.ajax({
                type: "POST",
                url : '<?=base_url()?>'+"admin/KG_Reportcard/searchkgimpro/",
                data : data,

                success : function(e)
                {
                //  alert(e);
                 $("#descsearchresult").html(e);
                }
            });
    }
</script>