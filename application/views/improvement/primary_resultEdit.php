...
<h1>
<i class="fa fa-mortar-board"></i> Primary Improvement Results <small><?php echo $this->lang->line('student_fees1'); ?></small>
</h1>
...
<?=form_open('improvement/Improvement_result/primaryresult_edit')?>
<input type="hidden" name="stuid" value="<?php echo $resultlist->student_id; ?>">
<input type="hidden" name="clsid" value="<?php echo $resultlist->class_id; ?>">
<input type="hidden" name="subid" value="<?php echo $resultlist->subject_id; ?>">
...
<td colspan="5"> Class	:	<span style="width:10%;text-align:left;padding-left:10px;"><?=$resultlist->class?>(<?=$resultlist->section?>)</span><br/>
...
<tr>
<td colspan="3"><h3>သင္ခန္းစာေခါင္းစဥ္ : <?=$resultlist->subname?></h3></td>
</tr>
<tr>
    <th>Student</th>
    <th>Month</th>
...
<tr>
    ...
    <td><?php echo $resultlist->month; ?></td>
    <td class="grade">
