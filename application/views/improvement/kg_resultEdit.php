...
<h1>
<i class="fa fa-mortar-board"></i> KG Improvement Results <small><?php echo $this->lang->line('student_fees1'); ?></small>
</h1>
...
<?=form_open('improvement/Improvement_result/kgresult_edit')?>
<input type="hidden" name="kgid" value="<?php echo $resultlist->kgid; ?>">
<input type="hidden" name="title_id" value="<?php echo $resultlist->improvement_id; ?>">
<input type="hidden" name="des_id" value="<?php echo $resultlist->description_id; ?>">
...
<tr>
    <td colspan="3"><h4>Description : <?=$resultlist->description?></h4></td></td>
</tr>
<tr>
    <th>Student</th>
    <th>Month</th>
