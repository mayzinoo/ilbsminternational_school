...
<td class="" colspan="5" style="font-weight:bold;"> Class	:	<span style="width:10%;text-align:left;padding-left:10px;"><?=$resultlist->cls?>(<?=$resultlist->section?>)</span><br/>
Teacher : <span style="text-align:left;padding-left:10px;"><?=$resultlist->teacher?></span><br/>
...
?>
    <tr>
        ...
        <td class="mailbox-date">
            <a href="<?php echo base_url(); ?>improvement/Improvement_result/kgedit_show/<?php echo $row->kgid?>/<?php echo $row->description_id?>/" class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('edit'); ?>">
