...
<h1>
<i class="fa fa-credit-card"></i> Primary Results Form<small></small>        </h1>
</section>
...
<form id="form1" action="<?php echo base_url() ?>improvement/Improvement_result/search_primarystudent"  id="improvement" name="improvement" method="post" enctype="multipart/form-data" accept-charset="utf-8">
<div class="box-body">
...
<div class="box-header with-border">
<h3 class="box-title"><?php //echo $title;     ?>Add New Primary Results</h3>
</div><!-- /.box-header -->
<div class="row box-body">
<div class="box-info with-border">

<?=form_open('improvement/Improvement_result/primaryresult_create')?>
...
?>">
   ...
   <?php echo form_dropdown("subject",$subject,"","class='form-control'"); ?>
...
?>">
    <!-- <label for="exampleInputEmail1">အၾကိမ္</label>-->

   <!--<?php echo form_dropdown("examtime",$examtime,"","class='form-control'"); ?> -->
