...
var nicEditorConfig = bkClass.extend({
	...
	iconsPath : 'http://essentialsmsilbsm.minguntechnology.com/backend/js/nicEditorIcons.gif',
...
var nicUploadButton = nicEditorAdvancedButton.extend({	
  ...
  uploadFile : function() {
    ...
    xhr.open("POST", "http://essentialsmsilbsm.minguntechnology.com/js/image.php");
